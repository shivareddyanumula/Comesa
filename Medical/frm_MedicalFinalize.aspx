<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frm_MedicalFinalize.aspx.cs" Inherits="Approval_frm_MedicalFinalize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center" style="vertical-align: top;">
        ...
        <tr>
            <td align="center">
                <asp:Label ID="lbl_MedicalBenfitClaimHeader" runat="server" Text="Medical Benefits Claim Approve" Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                                            ...
                                            <telerik:RadGrid ID="Rg_MedicalClaim" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <MasterTableView CommandItemDisplay="Top">
                                                    <Columns>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="MED_STATUS" UniqueName="MED_STATUS" HeaderText="MED_STATUS" 
                                                            meta:resourcekey="MED_STATUS" Visible="false">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                        </telerik:GridBoundColumn>
                            ...
                            <ContentTemplate>
                                ...
                                <td colspan="3" align="left">
                                    ...
                                    <tr id="trMedicalSvcPrvdr" runat="server" visible="false">
                                        <td style="width: 150px;">
                                            <%--<asp:Label ID="lblMedicalServiceProvider" runat="server" Text="Medical Service Provider Name" meta:resourcekey="lblMedicalServiceProvider"></asp:Label>--%>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblExpenditureMaxEligibleAmount" runat="server" Text="Expenditure Max Eligible Amount" meta:resourcekey="lblExpenditureName"></asp:Label>
                                        </td>
                                        <td>:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblAvailableAmounttxt" runat="server" Text="Available Amount" meta:resourcekey="lblExpenditureName"></asp:Label>
                                        </td>
                                        <td>:
                                        </td>
                                        <td>
                                    ...
                                    <tr id="MAXCURR" runat="server">
                                        <td>
                                            <asp:Label ID="lbl_maxcurrencyamt" runat="server" Text="Amount After Convertion"></asp:Label></td>
                                        <td>:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="width: 150px;">
                                            <asp:Label ID="lblAmount" runat="server" Text="Amount" meta:resourcekey="lblAmount"></asp:Label>
                                        </td>
                                        <td>:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadDatePicker ID="rdpInvoiceDate" runat="server">
                                             ...
                                             <telerik:RadDatePicker ID="rdpInvoiceDate1" runat="server" Visible="false"> 
                                            </telerik:RadDatePicker>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            ...
                                            <asp:Button ID="btn_Save" runat="server" meta:resourcekey="btn_Save" OnClick="btn_Save_Click"
                                                Text="Save" Visible="False" ValidationGroup="Controls" />
                                            <asp:Button ID="btnFinalize" runat="server" Text="Approve" ValidationGroup="Controls" OnClick="btn_Save_Click" Visible="false" />
