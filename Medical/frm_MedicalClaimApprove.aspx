<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frm_MedicalClaimApprove.aspx.cs" Inherits="Medical_frm_MedicalClaimApprove" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center" style="vertical-align: top;">
        ...
        <tr>
            <td align="center">
                <asp:Label ID="lbl_MedicalBenfitClaimHeader" runat="server" Text="Medical Benefits Claim Confirm" Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            ...
                                            <asp:Button ID="btnApprove" runat="server" OnClick="btn_Save_Click"
                                                Text="Confirm" Visible="False" ValidationGroup="Controls" />
