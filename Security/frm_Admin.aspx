<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="frm_Admin.aspx.cs" Inherits="Security_frm_Admin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center" style="width: 50%;">
        ...
        <tr>
            <td>
                <telerik:RadMultiPage ID="Rm_UM_page" runat="server" SelectedIndex="0" Height="490px"
                    ScrollBars="Auto">
                    ...
                    <telerik:RadPageView ID="Rp_UM_ViewDetails" runat="server">
                        <table align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="rfv_rcmb_UserManagerUserGroups" runat="server" ControlToValidate="rcmb_UserManagerUserGroups"
                                        ErrorMessage="Select a User Group" InitialValue="Select" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="rfv_rcmb_Organisation" runat="server" ControlToValidate="rcmb_Organisation"
                                        ErrorMessage="Select Organisation" InitialValue="Select" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="rtxt_UserManagerUserName" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="rfv_rtxt_UserManagerUserName" runat="server" ControlToValidate="rtxt_UserManagerUserName"
                                        ErrorMessage="UserName Cannot be Empty" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="rtxt_UserManagerPassword" runat="server" MaxLength="20" Width="200px"
                                        TextMode="Password"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="rfv_rtxt_UserManagerPassword" runat="server" ControlToValidate="rtxt_UserManagerPassword"
                                        ErrorMessage="Password Cannot be Empty" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="rtxt_UserManagerEmail" runat="server" Width="200px"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_PassCode" runat="server" Width="200px" MaxLength="10" TextMode="Password"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="rfv_txt_PassCode" runat="server" ControlToValidate="txt_PassCode"
                                        ErrorMessage="Security Code Cannot be Empty" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="rcmb_UserManagerBusinessUnit"
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    <asp:Button ID="btn_Update" runat="server" meta:resourcekey="btn_Update" OnClick="btn_Save_Click"
                                        Text="Update" ValidationGroup="Controls" Visible="False" /><asp:Button ID="btn_Save"
                                            runat="server" meta:resourcekey="btn_Save" OnClick="btn_Save_Click" Text="Save"
                                            ValidationGroup="Controls" Visible="False" /><asp:Button ID="btn_Cancel" runat="server"
                                                meta:resourcekey="btn_Cancel" OnClick="btn_Cancel_Click" Text="Cancel" /><asp:ValidationSummary
