<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="Frm_Manager_Feedback.aspx.cs" Inherits="PMS_Frm_Manager_Feedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            ...
            <td colspan="3" align="right">
                <asp:Label ID="lbl_Heading" runat="server" Text="Manager Periodic Feedback" Font-Bold="true"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <tr>
                ...
                <td align="left" class="style3">
                    ...
                    <telerik:RadComboBox ID="rtxt_AppraisalCycle" runat="server" Filter="Contains"
                        AutoPostBack="True" MarkFirstMatch="true" MaxHeight="120px" OnSelectedIndexChanged="rtxt_AppraisalCycle_SelectedIndexChanged">
                    </telerik:RadComboBox>
                </td>
                <td></td>
                <td>
            ...
            <tr>
                ...
                <td align="left">
                    <telerik:RadComboBox ID="rcmb_EmployeeType" runat="server" AutoPostBack="True" MarkFirstMatch="true"
    ...
    <telerik:RadMultiPage ID="RM_All" runat="server" Width="100%" SelectedIndex="0">
        <telerik:RadPageView ID="RP_All" runat="server" Selected="True" meta:resourcekey="RP_TaskDetailsResource1">
            <table align="center" width="70%">
                <tr>
                    <td align="center">
                        <telerik:RadGrid ID="RG_All" runat="server" Width="100%" AutoGenerateColumns="False"
                            AllowSorting="True" AllowMultiRowSelection="False" OnItemCommand="RG_All_ItemCommand"
                            ...
                            <MasterTableView DataKeyNames="ROLEKRA_ID,A" AllowMultiColumnSorting="True">
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="ROLEKRA_ID" Visible="False">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridBoundColumn DataField="A" HeaderText="Type" UniqueName="A">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" HeaderText="AddFeedback">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnk_AddFeedback" runat="server" CommandArgument='<%# Eval("ROLEKRA_ID") %>'
                                                OnCommand="lnk_all_addcomand" Text="AddFeedback"></asp:LinkButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn AllowFiltering="False" HeaderText="ViewFeedback">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="False" Visible="false">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnk_update" runat="server" CommandArgument='<%# Eval("ROLEKRA_ID") %>' CommandName='<%# Eval("A") %>'
                                                OnCommand="lnk_goalupdate_command" Text="Update" Visible="false"></asp:LinkButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridBoundColumn DataField="KRA_ID" HeaderText="KRA_ID" UniqueName="KRA_ID" Visible="False">
                                    </telerik:GridBoundColumn>
                                </Columns>
                                <%--<DetailTables>
                                    <telerik:GridTableView DataKeyNames="PF_FEEDBACK_ID" Name="Feedback" Width="100%">
                ...
                <tr align="center">
                    <td>
                        <asp:Button ID="Button1" Text="Submit" Visible="false" runat="server" OnClick="btn_Submit_GoalFeedback_click" />
                    </td>
                </tr>
            </table>
        </telerik:RadPageView>
