<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrainingRequestPopup.aspx.cs" Inherits="PMS_TrainingRequestPopup" %>
                ...
                <tr>
                    <td>
                        <telerik:RadMultiPage ID="Rm_Course_page" runat="server" SelectedIndex="0" Style="z-index: 10"
                            Width="770px" Height="390px" ScrollBars="Auto">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            ...
                                            <telerik:RadGrid ID="RGBatcheDetails" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                ...
                                                AllowFilteringByColumn="true" OnNeedDataSource="RGBatcheDetails_NeedDataSource" Width="700px">
                                                <MasterTableView>
                                                    <Columns>
