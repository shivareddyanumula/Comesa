<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="frm_ShortListApplicantsView.aspx.cs" Inherits="Recruitment_frm_applicantadd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphDefault" runat="Server">
    <%--<telerik:RadAjaxManagerProxy runat="server" ID="RAM_Employee">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="lnk_Applicant_Edit">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="RG_Applicant">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="btn_Exp_Correct">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Lang_Correct">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Qual_Correct">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Ref_Correct">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Skill_Correct">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Contact_Correct">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Exp_Add">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Lang_Add">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Qual_Add">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Ref_Add">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Skill_Add">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Contact_Add">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Exp_Cancel">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Lang_Cancel">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Qual_Cancel">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Ref_Cancel">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Skill_Cancel">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="btn_Contact_Cancel">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="RG_Experience">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="RG_Contact">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="RG_Reference">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="RG_Qualification">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="RG_Skills">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RAL_Panel_Main_c" LoadingPanelID="RAL_Panel_Main" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <telerik:RadScriptBlock ID="RSB_Employee" runat="server">
        ...
        <script type="text/javascript">
            ...
            function onGenderCheck(sender, eventArgs) {
                ...
                if (item.get_text().toUpperCase() == "MR.") {
                        ...
                        <asp:UpdatePanel ID="updApplicant" runat="server">
                            <ContentTemplate>
                                <table style="width: 80%;" align="center">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <telerik:RadTabStrip ID="RTS_Applicant"
                                                runat="server" Skin="WebBlue"
                                                MultiPageID="RMP_Applicant_1" SelectedIndex="2" Align="Center">
                                                <Tabs>
                                            ...
                                            <telerik:RadMultiPage ID="RMP_Applicant_1" runat="server" Width="70%" SelectedIndex="2">
                                                <telerik:RadPageView ID="Personal" runat="server" Selected="True">
                                                    <br />
                                                    <table align="center">
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblCode" runat="server" meta:resourcekey="lblCode"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_AppCode" runat="server" EmptyMessage="Auto Generated Code"
                                                            ...
                                                            <td></td>
                                                            <td align="left">
                                                                <asp:Label ID="lblBloodGroup" runat="server" meta:resourcekey="lblBloodGroup"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_BloodGroup" runat="server" Skin="WebBlue"
                                                                    TabIndex="7" MarkFirstMatch="true" Filter="Contains">
                                                                    <Items>
                                                            ...
                                                            <td align="left">
                                                                <asp:RequiredFieldValidator ID="rfv_BloodGroup" runat="server" ControlToValidate="ddl_BloodGroup"
                                                                    ErrorMessage="Choose Blood Group" InitialValue="Select" Text="*" ValidationGroup="Controls"></asp:RequiredFieldValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Title" runat="server" Skin="WebBlue" OnClientSelectedIndexChanged="onGenderCheck"
                                                            ...
                                                            <td></td>
                                                            <td align="left">
                                                                <asp:Label ID="lblReligion" runat="server" meta:resourcekey="lblReligion"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Religion" runat="server" Skin="WebBlue"
                                                                    TabIndex="8" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td align="left">
                                                                <asp:Label ID="lblNationality" runat="server" meta:resourcekey="lblNationality"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Nationality" runat="server" TabIndex="9" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblMiddleName" runat="server" meta:resourcekey="lblMiddleName"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Status" runat="server" Skin="WebBlue" TabIndex="10" MarkFirstMatch="true">
                                                                    <Items>
                                                                        <telerik:RadComboBoxItem runat="server" Text="Select" Value="Select" />
                                                                        <telerik:RadComboBoxItem runat="server" Text="Applied" Value="Applied" />
                                                                        <telerik:RadComboBoxItem runat="server" Text="Inprogress" Value="Inprogress" />
                                                                        <telerik:RadComboBoxItem runat="server" Text="Selected" Value="Selected" />
                                                                        <telerik:RadComboBoxItem runat="server" Text="Shortlisted" Value="Shortlisted" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td align="left">
                                                                <asp:Label ID="lblMaritalStatus" runat="server" meta:resourcekey="lblMaritalStatus"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_MaritalStatus" runat="server" Skin="WebBlue"
                                                                    TabIndex="11" MarkFirstMatch="true">
                                                                    <Items>
                                                                        <telerik:RadComboBoxItem runat="server" Text="Select" Value="Select" />
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblDOB" runat="server" meta:resourcekey="lblDOB"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <b>:</b>
                                                            </td>
                                                            <td align="left" colspan="3">
                                                                <telerik:RadDatePicker ID="txt_DOB" runat="server" AutoPostBack="true" Skin="WebBlue"
                                                                    FocusedDate="2009-09-18" MinDate="1900-01-01" OnSelectedDateChanged="txt_DOB_SelectedDateChanged"
                                                                    TabIndex="5">
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_Address" runat="server" AutoCompleteType="Disabled" Skin="WebBlue"
                                                                    TabIndex="12">
                                                                    <EmptyMessageStyle Font-Italic="True" />
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Gender" runat="server" Skin="WebBlue" TabIndex="6" MarkFirstMatch="true">
                                                                    <Items>
                                                                        <telerik:RadComboBoxItem runat="server" Text="Select" Value="Select" />
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_Remarks" runat="server" AutoCompleteType="Disabled" Skin="WebBlue"
                                                                    TabIndex="13">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                            <td align="left"></td>
                                                    ...
                                                    <table align="right">
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="btn_Back" runat="server" meta:resourcekey="btn_Back" OnClick="btn_Back_Click"
                                                ...
                                                <telerik:RadPageView ID="Qualification" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Category" runat="server" MaxHeight="120px" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadNumericTextBox ID="txt_Percentage" runat="server" Skin="WebBlue">
                                                                </telerik:RadNumericTextBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Grade" runat="server" meta:resourcekey="ddl_Grade" Skin="WebBlue" MarkFirstMatch="true">
                                                                    <Items>
                                                            ...
                                                            <td align="left">
                                                                <asp:RequiredFieldValidator ID="rfv_grade" runat="server" Text="*" ValidationGroup="Qual"
                                                                    ControlToValidate="ddl_Grade" InitialValue="Select" meta:resourcekey="rfv_grade"></asp:RequiredFieldValidator>
                                                            </td>
                                                        </tr>
                                                        <%--   <tr>
                                                            <td align="center" colspan="5">
                                                                <asp:Button ID="btn_Qual_Add" ValidationGroup="Qual" runat="server" Text="Add" OnClick="btn_Qual_Add_Click" />
                                                                <asp:Button ID="btn_Qual_Correct" ValidationGroup="Qual" runat="server" Text="Correct"
                                                                    OnClick="btn_Qual_Correct_Click" />
                                                                <asp:Button ID="btn_Qual_Cancel" ValidationGroup="Qual" runat="server" Text="Cancel"
                                                                    OnClick="btn_Qual_Cancel_Click" />
                                                            </td>
                                                            <td align="center">
                                                            </td>
                                                        </tr>--%>
                                                    ...
                                                    <table align="center" style="width: 100%">
                                                        <tr>
                                                            <td style="width: 100%" align="center">
                                                                <telerik:RadGrid ID="RG_Qualification" runat="server" Skin="WebBlue"
                                                                    GridLines="None" Width="100%" AutoGenerateColumns="False" OnItemCommand="RG_Qualification_ItemCommand">
                                                                    <ClientSettings>
                                                ...
                                                <telerik:RadPageView ID="AppSkill" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadComboBox ID="rcb_Skill" runat="server" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadComboBox ID="rcb_YearLastUsed" runat="server" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <%--  <tr>
                                                            <td colspan="4" align="center">
                                                                ...
                                                                <asp:Button ID="btn_Skill_Correct" runat="server" ValidationGroup="Skills" Text="Correct"
                                                                    OnClick="btn_Skill_Correct_Click" />
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            <td>
                                                                <telerik:RadGrid ID="RG_Skills" runat="server" Skin="WebBlue" GridLines="None"
                                                                    Width="100%" AutoGenerateColumns="False" OnItemCommand="RG_Skills_ItemCommand">
                                                                    <ClientSettings>
                                                                        <Selecting AllowRowSelect="True" />
                                                                    </ClientSettings>
                                                                    <MasterTableView>
                                                ...
                                                <telerik:RadPageView ID="Experience" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_ReasonRelieve" runat="server" Skin="WebBlue"
                                                                    TabIndex="5">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_CompanyName" runat="server" Skin="WebBlue"
                                                                    TabIndex="1">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadNumericTextBox ID="txt_RelSalary" runat="server" Skin="WebBlue"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadNumericTextBox ID="txt_JoinSalary" runat="server" Culture="English (United States)"
                                                                    Skin="WebBlue" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true"
                                                                    IncrementSettings-Step="0" TabIndex="3">
                                                                </telerik:RadNumericTextBox>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_RelDesc" runat="server" Skin="WebBlue" TabIndex="8">
                                                                    <EmptyMessageStyle Font-Italic="True" />
                                                                </telerik:RadTextBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_JoinDesc" runat="server" Skin="WebBlue"
                                                                    TabIndex="4">
                                                                    <EmptyMessageStyle Font-Italic="True" />
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <%-- <td colspan="3">
                                                                <asp:Button ID="btn_Exp_Add" runat="server" ValidationGroup="Exp" OnClick="btn_Exp_Add_Click"
                                                                    Text="Add" />
                                                                <asp:Button ID="btn_Exp_Correct" runat="server" ValidationGroup="Exp" OnClick="btn_Exp_Correct_Click"
                                                                    Text="Correct" />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <telerik:RadGrid ID="RG_Experience" Skin="WebBlue" runat="server" GridLines="None"
                                                                    Width="100%" AutoGenerateColumns="False" OnItemCommand="RG_Experience_ItemCommand">
                                                                    <MasterTableView>
                                                                        <Columns>
                                                ...
                                                <telerik:RadPageView ID="Contact" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_Serail_C" runat="server" Skin="WebBlue"
                                                                    ReadOnly="True">
                                                                    <EmptyMessageStyle Font-Italic="True" />
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadTextBox ID="txt_Address_C" runat="server" AutoCompleteType="Disabled"
                                                                    CausesValidation="True" Skin="WebBlue" LabelCssClass="" Rows="3">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <%-- <tr>
                                                            <td align="center" colspan="3">
                                                                <asp:Button ID="btn_Contact_Add" runat="server" Text="Add" ValidationGroup="Contact"
                                                                    OnClick="btn_Contact_Add_Click" />
                                                                <asp:Button ID="btn_Contact_Correct" runat="server" Text="Correct" ValidationGroup="Contact"
                                                                    OnClick="btn_Contact_Correct_Click" />
                                                                <asp:Button ID="btn_Contact_Cancel" runat="server" Text="Cancel" OnClick="btn_Contact_Cancel_Click" />
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                                    <br />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <telerik:RadGrid ID="RG_Contact" runat="server" GridLines="None" Height="100%" Width="98%"
                                                                    AutoGenerateColumns="False" OnItemCommand="RG_Contact_ItemCommand" Skin="WebBlue">
                                                                    <MasterTableView>
                                                                        <Columns>
                                                ...
                                                <telerik:RadPageView ID="Language" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Language" runat="server" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <%--    <tr>
                                                            <td align="center" colspan="3">
                                                                <asp:Button ID="btn_Lang_Add" runat="server" ValidationGroup="Lang" Text="Add" OnClick="btn_Lang_Add_Click" />
                                                                <asp:Button ID="btn_Lang_Correct" runat="server" ValidationGroup="Lang" Text="Correct"
                                                                    OnClick="btn_Lang_Correct_Click" />
                                                                <asp:Button ID="btn_Lang_Cancel" runat="server" Text="Cancel" OnClick="btn_Lang_Cancel_Click" />
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                                    <br />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <telerik:RadGrid ID="RG_Language" runat="server" GridLines="None" Height="100%" Width="98%"
                                                                    AutoGenerateColumns="False" OnItemCommand="RG_Language_ItemCommand" Skin="WebBlue">
                                                                    <MasterTableView>
                                                                        <Columns>
                                                                            <telerik:GridButtonColumn CommandName="Edit_Rec" Text="Edit&amp;nbsp Record" UniqueName="column">
                                                                            </telerik:GridButtonColumn>
                                                ...
                                                <telerik:RadPageView ID="Reference" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_BU" runat="server" Skin="WebBlue" AutoPostBack="true"
                                                                    MarkFirstMatch="true" OnSelectedIndexChanged="ddl_BU_SelectedIndexChanged" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td>
                                                                <asp:RequiredFieldValidator ID="rfv_BU" runat="server" ControlToValidate="ddl_BU"
                                                                    Display="Dynamic" InitialValue="Select" meta:resourcekey="rfv_BU" Text="*"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Employee" runat="server" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <telerik:RadComboBox ID="ddl_Relationship" runat="server" Skin="WebBlue" MarkFirstMatch="true" Filter="Contains">
                                                                </telerik:RadComboBox>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <%-- <tr>
                                                            <td align="center" colspan="3">
                                                                <asp:Button ID="btn_Ref_Add" runat="server" ValidationGroup="Referred" Text="Add"
                                                                    OnClick="btn_Ref_Add_Click" />
                                                                <asp:Button ID="btn_Ref_Correct" runat="server" ValidationGroup="Referred" Text="Correct"
                                                                    OnClick="btn_Ref_Correct_Click" />
                                                                <asp:Button ID="btn_Ref_Cancel" runat="server" Text="Cancel" OnClick="btn_Ref_Cancel_Click" />
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                                    <br />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <telerik:RadGrid ID="RG_Reference" Skin="WebBlue" runat="server" GridLines="None"
                                                                    Height="100%" AutoGenerateColumns="False" OnItemCommand="RG_Reference_ItemCommand">
                                                                    <MasterTableView>
                                                                        <Columns>
                                                                            <telerik:GridButtonColumn CommandName="Edit_Rec" Text="Edit&amp;nbsp Record" UniqueName="column">
                                                                            </telerik:GridButtonColumn>
                                                ...
                                                <telerik:RadPageView ID="Upload" runat="server">
                                                    ...
                                                    <table align="center">
                                                        <tr align="center">
                                                            <td>
                                                                <asp:Label ID="lbl_Upload" runat="server" meta:resourcekey="lbl_Upload" Text="Upload Resume"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:LinkButton ID="lnk_ViewResume" runat="server">Click Here to View</asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <br />
    ...
    <asp:ValidationSummary ID="vs_Skill" runat="server" ShowMessageBox="true" ShowSummary="false"
