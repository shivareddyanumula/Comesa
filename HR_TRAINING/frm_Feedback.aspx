<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="frm_FeedBack.aspx.cs" Inherits="Training_frm_FeedBack" %>
                                    ...
                                    <telerik:RadGrid ID="Rg_Feedback" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="FEEDBACKQUESTS_STATUS" HeaderText="Status" UniqueName="FEEDBACKQUESTS_STATUS"
                                                    Visible="True">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </telerik:GridBoundColumn>
                                ...
                                <td>
                                    <table align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadComboBox ID="rcmb_Category" runat="server" MaxLength="50" AutoPostBack="True" MarkFirstMatch="true" Filter="Contains">
                                                    <%--<Items>
                                                        ...
                                                        <telerik:RadComboBoxItem runat="server" Text="Counsellor" Value="Counseller" />
                                                        <telerik:RadComboBoxItem runat="server" Text="Course" Value="Course" />
                                                    </Items>--%>
                                                </telerik:RadComboBox>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lbl_Feedbackopt5" runat="server" Text="Option&nbsp;5"></asp:Label>
                                            </td>
                                            <td>
                                                :
                                            </td>
                                            <td>
                                                <telerik:RadTextBox ID="rtxt_Feedbackopt5" runat="server" MaxLength="20">
                                                </telerik:RadTextBox>
                                            </td>
                                            <td>
                                            </td>
