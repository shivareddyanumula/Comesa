                            ...
                            <tr id="tr_forms_id" runat="server" visible="false">
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="rfv_rcmb_Forms" runat="server"
                                        ...
                                        ValidationGroup="Controls" InitialValue="Select">*</asp:RequiredFieldValidator>
                                    <asp:ImageButton runat="server" ID="ibRfrsh" ImageUrl="~/Images/refreshIcon.png" OnClick="ibRfrsh_Click" />
                                </td>
                            </tr>
                        </table>
                        <table align="center">
                                        ...
                                        <MasterTableView CommandItemDisplay="None">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="LOGIN_USERNAME" HeaderText="User ID" meta:resourcekey="LOGIN_USERNAME"
                                                    UniqueName="LOGIN_USERNAME" ItemStyle-HorizontalAlign="Left" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridBoundColumn DataField="FORMS_NAME" HeaderText="Screen Name" meta:resourcekey="FORMS_NAME"
                                                    UniqueName="FORMS_NAME" ItemStyle-HorizontalAlign="Left" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                ...
                                                <telerik:GridBoundColumn DataField="OLD" HeaderText="Old Value" meta:resourcekey="OLD"
                                                    UniqueName="OLD" ItemStyle-HorizontalAlign="Left">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="NEW" HeaderText="New Value" meta:resourcekey="NEW"
                                                    UniqueName="NEW" ItemStyle-HorizontalAlign="Left">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="SMHR_AUDIT_MODIFIEDDATETIME" HeaderText="Created/Modified Date" meta:resourcekey="DATE"
