<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="Employees.aspx.cs" Inherits="HR_Employees" %>
                ...
                <telerik:RadMultiPage ID="RMP_Employees" runat="server" SelectedIndex="0">
                    <telerik:RadPageView ID="RPV_Employees" runat="server">
                        ...
                        <table align="center">
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="RG_Date" runat="server" ClientSettings-Scrolling-AllowScroll="true" ClientSettings-Scrolling-UseStaticHeaders="true">
                                    </telerik:RadGrid>
                                </td>
                            </tr>
                        </table>
