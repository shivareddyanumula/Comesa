<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DirectEmployerror.aspx.cs" Inherits="HR_DirectEmployerror" %>
...
<body>
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="1" 
        OnTabClick="RadTabStrip1_TabClick">
                        ...
                        <telerik:RadTab runat="server" TabIndex='1'  Text="Family" >
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" TabIndex='2' Text="Weekly Off">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" TabIndex='3' Text="Other Details">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" TabIndex='4' Text="physical Details">
                        </telerik:RadTab>                    
                        <telerik:RadTab runat="server" TabIndex='5' Text="Qualification">
                        </telerik:RadTab>    
                        
                         <telerik:RadTab runat="server" TabIndex='6' Text="Skills">
                        </telerik:RadTab>                    
                        <telerik:RadTab runat="server" TabIndex='7' Text="Experiance">
                        </telerik:RadTab>                    
                        <telerik:RadTab runat="server" TabIndex='8' Text="Contacts">
                        </telerik:RadTab>                    
                        <telerik:RadTab runat="server" TabIndex='9' Text="Language">
                        </telerik:RadTab>                    
