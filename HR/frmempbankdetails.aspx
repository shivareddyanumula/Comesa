    ...
    <telerik:RadScriptBlock ID="Rsb_Scripts" runat="server">
     ...
     <script type="text/javascript">        
        function validation() {
            ...
            debugger;
            if (hfEmpCnt.value != "0") {
                if (confirm("Employee has already assigned to Default bank. Do you wish to continue..? ") == true)
                    return true;
                else
                    return false;
            }           
                                    ...
                                    <telerik:RadGrid ID="RG_Identification" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="DEFAULT" UniqueName="DEFAULT"
                        ...
                        <table align="center">
                            ...
                            <caption>
                                ...
                                <tr runat="server" id="default1">
                                    ...
                                    <td runat="server">
                                        <asp:CheckBox ID="chk_Default" runat="server"  onclick="checkboxClick(this)" AutoPostBack="true"
                                            OnCheckedChanged="chk_Default_CheckedChanged"  />
                                ...
                                <tr>
                                    <td align="center" colspan="3">
                                        <asp:Button ID="btn_Add" runat="server" meta:resourcekey="btn_Add" OnClick="btn_Add_Click"
                                            OnClientClick="javascript:return validation();" ValidationGroup="Controls" /> <%--javascript:return validation(); &&--%>
