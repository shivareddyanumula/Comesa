<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="LoanRequestEmp.aspx.cs" Inherits="Selfservice_LoanRequestEmp" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="rcmb_BusinessUnit" runat="server" AutoPostBack="True" MarkFirstMatch="true" MaxHeight="120px"
                                                OnSelectedIndexChanged="rcmb_BusinessUnit_SelectedIndexChanged" Skin="WebBlue" Enabled="false" Filter="Contains">
                                            </telerik:RadComboBox>
                                        </td>
                                        <td>
