<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frmOverTimeCalc.aspx.cs" Inherits="Selfservice_frmOverTimeCalc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function validate(key) {
            ...
            if ((keycode < 58 && keycode > 47) || keycode == 8 || keycode == 11) {
                return true;
            }
            else return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="lbl_OverTime" runat="server" Font-Bold="true" Text="OverTime"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                                    ...
                                    <telerik:RadGrid ID="Rg_OverTime" runat="server" AllowFilteringByColumn="True"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top">
                                            <Columns>
                                                ...
                                                <%-- <telerik:GridBoundColumn DataField="OTCALC_DATE" HeaderText="OT Date"
                                                     UniqueName="OTCALC_DATE">
                                                </telerik:GridBoundColumn>--%>
                            ...
                            <ContentTemplate>
                                <table align="center" width="43%">
                                    ...
                                    <tr>
                                        ...
                                        <%-- <td align="left">--%>
                                        <td>
                                            <telerik:RadComboBox ID="rcmb_Employee" runat="server" AutoPostBack="True" MaxHeight="300px" Enabled="true"
                                    ...
                                    <tr>
                                        <%--<td align="right" width="40%">--%>
                                        <td>
                                            <asp:Label ID="lbl_Date" runat="server" Text="Date of Over Time"></asp:Label>
                                        ...
                                        <td>
                                            <telerik:RadDatePicker ID="rdtp_OTDt" runat="server" meta:resourcekey="rdtp_OTDt"
                                                Skin="WebBlue" OnSelectedDateChanged="rdtp_OTDt_SelectedDateChanged" SkipMinMaxDateValidationOnServer ="true" 
                                                AutoPostBack="True">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTimepicker ID="rdp_fromtime" runat="server" DateInput-DateFormat="HH:mm" TimeView-TimeFormat="HH:mm" AutoPostBack="true" OnSelectedDateChanged="rdp_fromtime_SelectedDateChanged"></telerik:RadTimepicker>
                                        </td>
                                           <td>
                                            <asp:RequiredFieldValidator ID="rfv_fromtime" runat="server" ControlToValidate="rdp_fromtime"
                                                ErrorMessage="Please Enter from time" Text="*" ValidationGroup="Controls"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                        ...
                                        <td><b>:</b>
                                         ...
                                         <td>
                                             <telerik:RadTimepicker ID="rdp_totime" runat="server" DateInput-DateFormat="HH:mm" TimeView-TimeFormat="HH:mm" AutoPostBack="true" OnSelectedDateChanged="rdp_totime_SelectedDateChanged"></telerik:RadTimepicker>
                                        </td>
                                          <td>
                                            <asp:RequiredFieldValidator ID="rfv_todate" runat="server" ControlToValidate="rdp_totime"
                                                ErrorMessage="Please Enter to time" Text="*" ValidationGroup="Controls"></asp:RequiredFieldValidator>
                                        </td>
                                       <%-- <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox runat="server" ID="rtbActHrs" Skin="Outlook" onkeypress="return validate(event)"
                                                Font-Names="Arial" SkinID="EmpExp" MaxLength="2" placeholder="HH" Enabled="false"
                                                AutoPostBack="true" OnTextChanged="rtbActHrs_TextChanged">
                                            </telerik:RadTextBox>
                                            <telerik:RadTextBox runat="server" ID="rtbActMins" Skin="Outlook" onkeypress="return validate(event)"
                                                Font-Names="Arial" SkinID="EmpExp" MaxLength="2" placeholder="MM" Enabled="false"
                                                AutoPostBack="true" OnTextChanged="rtbActHrs_TextChanged">
                                            </telerik:RadTextBox>
                                        </td>
                                   <%--     <td>
                                    ...
                                    <tr>
                                        <%--<td align="right" width="40%">--%>
                                        <td>
                                            <asp:Label ID="lbl_OTHours" runat="server" Text="OverTime Hours "></asp:Label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="rtxt_Comments" runat="server" Skin="WebBlue" DisabledStyle-BackColor="Window"
                                                Width="125px" MaxLength="200" Height="100" TextMode="MultiLine" Style="resize: none">
                                            </telerik:RadTextBox>
                                        </td>
                                        <%--<td></td>--%>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" colspan="3">
                                            <br />
                                            <asp:Button ID="btn_Submit" runat="server" Text="Submit" ValidationGroup="Controls" OnClick="btn_Submit_Click" Visible="false" />
