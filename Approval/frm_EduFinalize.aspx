<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frm_EduFinalize.aspx.cs" Inherits="Approval_frm_EduFinalize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" Runat="Server">
     <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="lbl_EducationDetHeader" runat="server" Font-Bold="true" Text="Educational Claim Approve"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                                    ...
                                    <telerik:RadGrid ID="Rg_Educationdet" runat="server" AllowFilteringByColumn="True"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="EDU_STATUS" HeaderText="EDU_STATUS"
                                                    UniqueName="EDU_STATUS" Visible="false">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                ...
                                <table align="center" width="40%">
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            ...
                                            <asp:Button ID="btn_Update" runat="server" Text="Update" ValidationGroup="Controls" OnClick="btn_Update_Click" Visible="false" />
                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" align="center">
                                            <asp:Button ID="btn_Approve" runat="server" Text="Conform the Claim" ValidationGroup="Controls" OnClick="btn_Submit_Click" Visible="false" />
                                              <asp:Button ID="btn_Finalize" runat="server" Text="Approve the Claim" ValidationGroup="Controls" OnClick="btn_Submit_Click" Visible="false" />
