...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="lbl_EducationDetHeader" runat="server" Font-Bold="true" Text="Educational Claim Confirm"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <table align="center" width="40%">
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <asp:Button ID="btn_Approve" runat="server" Text="Confirm the Claim" ValidationGroup="Controls" OnClick="btn_Submit_Click" Visible="false" />
