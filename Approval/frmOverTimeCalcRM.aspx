<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frmOverTimeCalcRM.aspx.cs" Inherits="Approval_frmOverTimeCalcRM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td align="center">
                <asp:Label ID="lbl_OverTime" runat="server" Font-Bold="true" Text="OverTime RM Approval"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
