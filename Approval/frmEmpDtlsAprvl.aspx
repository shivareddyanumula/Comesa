<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frmEmpDtlsAprvl.aspx.cs" Inherits="Approval_frmEmpDtlsAprvl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" Runat="Server">
    <table align="center" style="vertical-align: top;">
        <tr>
            <td align="center">
                <asp:Label ID="lblEmpDtlsAprvl" runat="server" Text=" Employee Details Approval " Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <telerik:RadMultiPage ID="rmpEmpDtlsAprvl" runat="server" SelectedIndex="0" Style="z-index: 10"
                    Width="100%">
                    <telerik:RadPageView ID="rpvEmpDtlsAprvl" runat="server" Selected="True">
                        <asp:UpdatePanel ID="upEmpDtlsAprvl" runat="server">
                            <ContentTemplate>
                                <table align="center" width="100%">
                                    <tr>
                                        <td>
                                            <telerik:RadGrid ID="rgEmpDtlsAprvl" runat="server" AutoGenerateColumns="False"
                                                AllowFilteringByColumn="True" AllowSorting="True" Skin="WebBlue" GridLines="None"
                                                OnNeedDataSource="rgEmpDtlsAprvl_NeedDataSource" AllowPaging="True" PageSize="10">
                                                ...
                                                <MasterTableView CommandItemDisplay="None">
                                                    <Columns>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="GRADE" HeaderText="Employee Grade"
