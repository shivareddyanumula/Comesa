...
public partial class Reportss_PF_contribution : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("PF Contribution");
    ...
    //    //{
    //    //    ReportDataSource EmpDS = new ReportDataSource("PF Contribution", 
    //    //                        BLL.ExecuteQuery(" EXEC RPT_USP_SALARYREGISTER " +
    //    //                    " @BUSINESSUNIT = '" + Convert.ToInt32(rcmb_BusinessUnit.SelectedValue) + "'," +
    //    //                    " @PERIOD = '" + Convert.ToInt32(rcmb_Period.SelectedValue) + "',"+
    //    //                    "@PERIOD_ELEMENT='"+Convert.ToInt32(rcmb_PeriodElements.SelectedValue)+"'"));
    //    //    rvPFcontribution.LocalReport.ReportPath = @"Report_rdlc\Salary Register.rdl";
    //    //    rvPFcontribution.LocalReport.DataSources.Clear();
    //    //    rvPFcontribution.LocalReport.DataSources.Add(EmpDS);
    //    //    rvPFcontribution.LocalReport.Refresh();
    //    //    rvPFcontribution.Style.Add("Display", "block");
    //    //}
    //    //else
    //    //{
    //    //    rvPFcontribution.Style.Add("Display", "none");
    //    //}
    //}
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        try
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_Period.SelectedItem.Value) + "','" + Convert.ToString(rcmb_PeriodElements.SelectedItem.Value) + "','" + Convert.ToString(rcmb_BusinessUnit.SelectedValue) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "PF_contribution", ex.StackTrace, DateTime.Now);
