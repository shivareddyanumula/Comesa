<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="DeadEmployees.aspx.cs" Inherits="Reportss_DeadEmployees" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/DeadEmployeesReport.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Relieving Report");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Relieving Employee Report" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <telerik:RadDatePicker ID="rdp_Period" runat="server"></telerik:RadDatePicker>
                <%--<telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payperiod" runat="server" Skin="WebBlue" AutoPostBack="true"
                    OnSelectedIndexChanged="rcmb_payperiod_SelectedIndexChanged">
                </telerik:RadComboBox>--%>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                    ControlToValidate="rdp_Period" ErrorMessage="Please select Date"
        ...
        <%--<tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="rcmb_payElements" ErrorMessage="Please select Period Elements" 
                    InitialValue="Select" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
            </td>
        </tr>--%>
    ...
    <br />
    <%-- <center>
        <rsweb:ReportViewer ID="RPT_DeadEmployeeReport" runat="server" Width="950px" Height="518px"
