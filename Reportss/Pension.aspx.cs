...
public partial class Reportss_Pension : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Pension ");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Pension", ex.StackTrace, DateTime.Now);
    ...
    protected void rcmb_payperiod_SelectedIndexChanged(object o, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
    {
        try
        {
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_PeriodDetails.SelectedValue) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Pension", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            rcmb_PeriodDetails.SelectedIndex = 0;
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Pension", ex.StackTrace, DateTime.Now);
