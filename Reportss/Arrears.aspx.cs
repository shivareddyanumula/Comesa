...
public partial class Reportss_Arrears : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Arrears", ex.StackTrace, DateTime.Now);
    ...
    protected void rcmb_Period_SelectedIndexChanged(object o, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
    {
        try
        {
            if (rcmb_Period.SelectedIndex != 0)
            {
                ...
                {
                    rcmb_FromPeriodElements.DataSource = dt_Details;
                    rcmb_FromPeriodElements.DataValueField = "PRDDTL_ID";
                    rcmb_FromPeriodElements.DataTextField = "PRDDTL_NAME";
                    rcmb_FromPeriodElements.DataBind();
                    rcmb_FromPeriodElements.Items.Insert(0, new RadComboBoxItem("Select"));

                    rcmb_ToPeriodElements.DataSource = dt_Details;
                    rcmb_ToPeriodElements.DataValueField = "PRDDTL_ID";
                    rcmb_ToPeriodElements.DataTextField = "PRDDTL_NAME";
                    rcmb_ToPeriodElements.DataBind();
                    rcmb_ToPeriodElements.Items.Insert(0, new RadComboBoxItem("Select"));
                }
            }
            else
            {
                rcmb_FromPeriodElements.Items.Clear();
                rcmb_ToPeriodElements.Items.Clear();
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            rcmb_FromPeriodElements.SelectedIndex = 0;
            rcmb_ToPeriodElements.SelectedIndex = 0;
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Arrears", ex.StackTrace, DateTime.Now);
