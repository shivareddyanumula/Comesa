<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="EmployeePayHistory.aspx.cs" Inherits="Reportss_EmployeePayHistory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU) {
            var win = window.radopen('../Reportss/EmployeePayHistoryReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Employee Pay History Report");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Employee Pay History Report" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_EmployeePayHistory" runat="server" ShowMessageBox="true"
