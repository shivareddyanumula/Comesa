...
public partial class Reportss_EmployeeExperienceDetailsReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_EmployeeExperienceDetails.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_EmployeeExperienceDetails.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "EmployeeExperienceDetails";
                ...
                RPT_EmployeeExperienceDetails.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EmployeeExperienceDetailsReport", ex.StackTrace, DateTime.Now);
