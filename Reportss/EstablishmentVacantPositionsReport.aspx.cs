...
public partial class Reportss_EstablishmentVacantPositionsReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_EstablishmentVacantPositions.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_EstablishmentVacantPositions.ServerReport;
                ...
                //serverReport.ReportPath = MyReportPath + "Vacancy Report";
                ...
                Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Organisation, BusinessUnit, Period };
                serverReport.SetParameters(parameters);
                serverReport.Refresh();
                RPT_EstablishmentVacantPositions.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EstablishmentVacantPositionsReport", ex.StackTrace, DateTime.Now);
