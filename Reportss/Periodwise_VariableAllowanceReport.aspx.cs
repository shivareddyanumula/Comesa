...
public partial class Reportss_Periodwise_VariableAllowanceReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_periodwise_variableallowance.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_periodwise_variableallowance.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "periodwise_variableallowance";
                ...
                RPT_periodwise_variableallowance.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Periodwise_VariableAllowanceReport", ex.StackTrace, DateTime.Now);
