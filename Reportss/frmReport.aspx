<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frmReport.aspx.cs" Inherits="Reportss_frmReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />

    <script type="text/javascript">
        function ShowPop(BU, prd, prdDtl, str) {
            var win = window.radopen('../Reportss/FrmReportData.aspx?BU=' + BU + '&prd=' + prd + '&prdDtl=' + prdDtl + '&rptStr=' + str, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Report");
