<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="Pms_GSDone.aspx.cs" Inherits="Reportss_Pms_GSDone" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function ShowPop(ID, BU, SAL, RptMgr) {
            var win = window.radopen('../Reportss/PmsGSDoneReport.aspx?ORG_ID=' + ID + '&BU=' + BU + '&AppCycle=' + SAL + '&RptMgr=' + RptMgr, "RadWindow1");
            win.center();
            win.set_modal(true);
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Goal Setting Status"
