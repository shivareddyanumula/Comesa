...
public partial class Reportss_DependentsInformationReoprt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Dependents Information");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "DependentsInformationReoprt", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_DependentReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_DependentReport.ServerReport;

            //RPT_DependentReport.AsyncRendering = false;
            //if (!RPT_DependentReport.Enabled)
            //{
            //    RPT_DependentReport.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "DependentsInformation";
            ...
            //RPT_DependentReport.Visible = true;
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            // RPT_DependentReport.Visible = false;
