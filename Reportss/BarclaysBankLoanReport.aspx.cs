...
public partial class Reportss_BarclaysBankLoanReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                serverReport.ReportPath = MyReportPath + "BarclaysBankLoan";
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "BarclaysBankLoanReport", ex.StackTrace, DateTime.Now);
