<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="StaffWelfareLoan.aspx.cs" Inherits="Reportss_StaffWelfareLoan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/StaffWelfareLoanReport.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Staff Welfare Loan");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Staff Welfare Loan Report" Font-Bold="True"
    ...
    <br />
    <%--<center>
        <rsweb:ReportViewer ID="RPT_WElfareTax" runat="server" Width="950px" Height="518px"
