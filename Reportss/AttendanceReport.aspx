<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="AttendanceReport.aspx.cs" Inherits="Reportss_AttendanceReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/AttendanceReports.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_behaviors(Telerik.Web.UI.WindowBehaviors.Maximize + Telerik.Web.UI.WindowBehaviors.Close);
        }

        function ShowPopup(BU, PRD, PDTL) {
            var win = window.radopen('../Reportss/MonthWiseEmployeeNotPaidReport.aspx?BU=' + BU + '&PRD=' + PRD + '&PDTL=' + PDTL, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Month Wise Employee Not Paid");
            win.set_behaviors(Telerik.Web.UI.WindowBehaviors.Maximize + Telerik.Web.UI.WindowBehaviors.Close);
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payElements" runat="server" Filter="Contains"
                    Skin="WebBlue" AutoPostBack="True" MaxHeight="200px" MarkFirstMatch="true" OnSelectedIndexChanged="rcmb_payElements_SelectedIndexChanged">
                </telerik:RadComboBox>
            </td>
            <td>
    ...
    <%--<table align="center">
        <tr>
            <td>
                <rsweb:ReportViewer ID="RPT_Attendance" runat="server" Width="950px" Height="518px"
