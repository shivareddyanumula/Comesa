...
public partial class Reportss_EmployeeLeaveDetailReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_EmployeeLeaveDetail.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_EmployeeLeaveDetail.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "EmployeeLeaveDetailReport";
                ...
                RPT_EmployeeLeaveDetail.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EmployeeLeaveDetailReport", ex.StackTrace, DateTime.Now);
