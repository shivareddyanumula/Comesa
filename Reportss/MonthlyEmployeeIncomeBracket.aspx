<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="MonthlyEmployeeIncomeBracket.aspx.cs" Inherits="Reportss_MonthlyEmployeeIncomeBracket" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, prddtl, BU) {
            var win = window.radopen('../Reportss/MonthlyEmployeeIncomeBracketReport.aspx?PRD=' + url + '&PRDDTL=' + prddtl + '&BU=' + BU, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Monthly Employee Income Bracket Report");
