...
public partial class Reportss_Paye : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("PAYE");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Paye", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //    RPT_Paye.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //    Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //    serverReport = RPT_Paye.ServerReport;

            //    RPT_Paye.AsyncRendering = false;
            //    if (!RPT_Paye.Enabled)
            //    {
            //        RPT_Paye.CurrentPage = 1;
            //    }
            ...
            //    serverReport.ReportPath = "/SmartHR Kenya MT/" + "PAYE";
