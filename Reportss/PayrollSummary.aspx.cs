...
public partial class Reportss_PayrollSummary : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Payroll Summary");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "PayrollSummary", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_PayRoll.AsyncRendering = false;
            //if (!RPT_PayRoll.Enabled)
            //{
            //    RPT_PayRoll.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "PayRollSummary";
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_payElements.SelectedValue) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "', '" + Localisation + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "PayrollSummary", ex.StackTrace, DateTime.Now);
