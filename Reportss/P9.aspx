<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="P9.aspx.cs" Inherits="Reportss_P9" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/P9Report.aspx?PRD=' + url + '&BU=' + ID + '&EMP=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Form P9");
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="P9 Report" Font-Bold="True" Font-Names="Arial"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfv_ddl_BusinessUnit" runat="server" ControlToValidate="ddl_BusinessUnit" InitialValue="Select" ErrorMessage="Please Select Business Unit" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddl_Employee"
                    ErrorMessage="Please Select Employee" InitialValue="Select" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payperiod" runat="server" MarkFirstMatch="true"
                    ...
                    Sort="Ascending" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="rfv_rcmb_payperiod" runat="server" ControlToValidate="rcmb_payperiod"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payElements" runat="server" MarkFirstMatch="true" Filter="Contains"
