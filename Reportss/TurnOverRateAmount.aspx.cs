...
public partial class Reportss_TurnOverRateAmount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Turnover Rate by Department in terms of Amount");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "TurnOverRateAmount", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            // RPT_TurnOverAountReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            // Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            // serverReport = RPT_TurnOverAountReport.ServerReport;

            // RPT_TurnOverAountReport.AsyncRendering = false;
            // if (!RPT_TurnOverAountReport.Enabled)
            // {
            //     RPT_TurnOverAountReport.CurrentPage = 1;
            // }
            ...
            // serverReport.ReportPath = "/SmartHR Kenya MT/" + "TurnOverRateByDepartmentIntermsofAmount";
            ...
            //     FromDate = new Microsoft.Reporting.WebForms.ReportParameter("FromDate", txt_StartDate.SelectedDate.Value.ToShortDateString());
            //     ToDate = new Microsoft.Reporting.WebForms.ReportParameter("ToDate", txt_EndDate.SelectedDate.Value.ToShortDateString());
            //     Microsoft.Reporting.WebForms.ReportParameter[] parameters = { BusinessGroup,FromDate,ToDate,Department,Organisation  };
            //     serverReport.SetParameters(parameters);
            //     serverReport.Refresh();
            //     RPT_TurnOverAountReport.Visible = true;
            // }
            // if ((txt_StartDate.SelectedDate != null) && (txt_EndDate.SelectedDate == null))
            // {

            //     FromDate = new Microsoft.Reporting.WebForms.ReportParameter("FromDate", txt_StartDate.SelectedDate.Value.ToShortDateString());
            //     ToDate = new Microsoft.Reporting.WebForms.ReportParameter("ToDate", DateTime.Now.ToShortDateString());
            //     Microsoft.Reporting.WebForms.ReportParameter[] parameters = { BusinessGroup, FromDate, ToDate, Department, Organisation };
            //     serverReport.SetParameters(parameters);
            //     serverReport.Refresh();
            //     RPT_TurnOverAountReport.Visible = true;
