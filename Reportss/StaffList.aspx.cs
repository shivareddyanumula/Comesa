...
public partial class Reportss_StaffList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Staff List");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "StaffList", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_SalaryList.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_SalaryList.ServerReport;

            //RPT_SalaryList.AsyncRendering = false;
            //if (!RPT_SalaryList.Enabled)
            //{
            //    RPT_SalaryList.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "StaffList";
            ...
            //Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Organisation, BusinessGroup,Department };
            //serverReport.SetParameters(parameters);
            //serverReport.Refresh();
            //RPT_SalaryList.Visible = true;
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "','" + Convert.ToString(rcb_Department.SelectedValue) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "StaffList", ex.StackTrace, DateTime.Now);
