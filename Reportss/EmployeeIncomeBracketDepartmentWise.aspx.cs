...
public partial class Reportss_EmployeeIncomeBracketDepartmentWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EmployeeIncomeBracketDepartmentWise", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_EmployeeIncomeReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_EmployeeIncomeReport.ServerReport;
            //RPT_EmployeeIncomeReport.AsyncRendering = false;
            //if (!RPT_EmployeeIncomeReport.Enabled)
            //{
            //    RPT_EmployeeIncomeReport.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "EmployeeIncomeBracket";
            ...
            //RPT_EmployeeIncomeReport.Visible = true;
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_payElements.SelectedValue) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "','" + Convert.ToString(ddl_Department.SelectedValue) + "','" + Convert.ToString(rcmb_Organisation) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EmployeeIncomeBracketDepartmentWise", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_EmployeeIncomeReport.Visible = false;
