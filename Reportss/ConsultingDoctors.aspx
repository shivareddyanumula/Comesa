<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="ConsultingDoctors.aspx.cs" Inherits="Reportss_ConsultingDoctors" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/consultingDoctorsReport.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Consulting Doctor");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Consulting Doctor Report" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="rcmb_payperiod"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payElements" runat="server" Filter="Contains"
                    Skin="WebBlue" AutoPostBack="True" MaxHeight="200px" OnSelectedIndexChanged="rcmb_payElements_SelectedIndexChanged" MarkFirstMatch="true">
                </telerik:RadComboBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="rcmb_payElements"
    ...
    <br />
    <%-- <center>
        <rsweb:ReportViewer ID="RPT_DoctorTax" runat="server" Width="950px" Height="518px"
