...
public partial class Reportss_YearWiseEmployeeSalaryReoprt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                serverReport.ReportPath = MyReportPath + "YearwiseEmployeeSalaryReport";
                ...
                {
                    Year = new Microsoft.Reporting.WebForms.ReportParameter("Year", Convert.ToString(Request.QueryString["PRD"]));
                }
                else
                {
                ...
                Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Organisation, Year, BusinessGroup, Department };
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "YearWiseEmployeeSalaryReoprt", ex.StackTrace, DateTime.Now);
