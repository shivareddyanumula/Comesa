...
public partial class Reportss_New_Reports_ChngtoBasicPayReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_ChngtoBasicPay.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_ChngtoBasicPay.ServerReport;
                ...
                Report_Name = "RptComparisionReport";
                ...
                RPT_ChngtoBasicPay.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "ChngtoBasicPayReport", ex.StackTrace, DateTime.Now);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Warning[] warnings;
            string[] streamids;
            byte[] exportBytes = RPT_ChngtoBasicPay.ServerReport.Render("PDF", null, out mimeType, out encoding, out fileNameExtension, out streamids, out warnings);
