<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="ChngtoBasicPay.aspx.cs" Inherits="Reportss_New_Reports_ChngtoBasicPay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(Org, BU, url, prddtl,sts) {
            ...
            var win = window.radopen('../NewReports/ChngtoBasicPayReport.aspx?ORG=' + Org + '&BU=' + BU + '&PRD=' + url + '&PRDDTL=' + prddtl + '&sts='+sts, "RadWindow1");
            win.center();
            win.set_modal(true);
          ///  win.set_width("670");
            win.set_title("Change to Basic Pay");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Change to Basic Pay Report" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_ChngtoBasicPay" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>
