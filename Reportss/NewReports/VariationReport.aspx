<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VariationReport.aspx.cs" Inherits="Reportss_NEW_VariationReport" %>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <rsweb:ReportViewer ID="RPT_Variation" runat="server" Height="518px" Width="950px"
