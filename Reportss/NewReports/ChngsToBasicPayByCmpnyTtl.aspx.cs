...
public partial class Reportss_New_Reports_ChngsToBasicPayByCmpnyTtl : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "ChngsToBasicPayByCmpnyTtl", ex.StackTrace, DateTime.Now);
