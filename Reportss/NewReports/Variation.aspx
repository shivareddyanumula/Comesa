<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="Variation.aspx.cs" Inherits="Reportss_NEW_VariationReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
     <script type="text/javascript">
         function ShowPop(Org, BU, url, prddtl,sts) {
             var win = window.radopen('../NewReports/VariationReport.aspx?ORG=' + Org + '&BU=' + BU + '&PRD=' + url + '&PRDDTL=' + prddtl+'&sts='+sts, "RadWindow1");
             win.center();
            /////////// win.set_modal(true);
             win.set_title("Variation Report");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Variation Report" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_Variation" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>
