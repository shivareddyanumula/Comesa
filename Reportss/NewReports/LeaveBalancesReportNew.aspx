<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaveBalancesReportNew.aspx.cs" Inherits="Reportss_NEW_Leave_Balances_Report_New" %>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <rsweb:ReportViewer ID="RPT_Leavebalancesnew" runat="server" Height="518px" Width="950px"
