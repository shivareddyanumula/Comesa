<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="EducationalClaim.aspx.cs" Inherits="Reportss_NewReports_EducationalClaim" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(BU,emp, url, prddtl,title) {
            debugger;
            var win = window.radopen('../NewReports/EducationalClaimReport.aspx?BU=' + BU + '&EMP=' + emp + '&PRD=' + url + '&PRDDTL=' + prddtl, "RadWindow1");
            win.center();
            win.set_modal(true);
            //////   win.set_width("400");
...
<%--<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" Runat="Server">--%>
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="" Font-Bold="true"
                ...
                <asp:RequiredFieldValidator ID="rfv_rcmb_Employee" runat="server" Text="*" InitialValue="Select"
                    ...
                    <tr id="tr_Employee1" runat="server">
                        <td colspan="4" style="text-align: center">
                            <asp:Button ID="btn_Submit" runat="server" Text="Generate" OnClick="btn_Submit_Click1"
    ...
    <asp:ValidationSummary ID="vs_BasicPayToDate" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>
