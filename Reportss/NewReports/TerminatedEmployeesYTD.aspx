<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="TerminatedEmployeesYTD.aspx.cs" Inherits="Reportss_NEW_TerminatedEmployeesYTD" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(Org, BU, url, prddtl,sts) {
            var win = window.radopen('../NewReports/TerminatedEmployeesYTDReport.aspx?ORG=' + Org + '&BU=' + BU + '&PRD=' + url + '&PRDDTL=' + prddtl+'&sts='+sts, "RadWindow1");
            win.center();
            ////////////win.set_modal(true);
            win.set_title("Terminated Employees YTD");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Terminated Employees Year to Department" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_TerminatedEmployeesYTD" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>
