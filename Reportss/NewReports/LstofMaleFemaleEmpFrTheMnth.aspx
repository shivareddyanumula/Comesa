<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="LstofMaleFemaleEmpFrTheMnth.aspx.cs" Inherits="Reportss_New_Reports_LstofMaleFemaleEmpFrTheMnth" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />

    <script type="text/javascript">
        function ShowPop(Org, BU, url, prddtl, Gdr,sts) {
            var win = window.radopen('../NewReports/LstofMaleFemaleEmpFrTheMnthReport.aspx?ORG=' + Org + '&BU=' + BU + '&PRD=' + url + '&PRDDTL=' + prddtl + '&Gdr=' + Gdr+'&sts='+sts, "RadWindow1");
            win.center();
            win.set_modal(true);
            //////////////win.set_width("670");
            win.set_title("List Of Male/Female Employees For The Month");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="List of Male/Female Employees for the Month" Font-Bold="true"
            ...
            <td>
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="rcmb_Gender" runat="server" MarkFirstMatch="true" MaxHeight="120px" AutoPostBack="true">
                                <Items>
                                    <telerik:RadComboBoxItem Text="Select" Value="-1" />
                                    <telerik:RadComboBoxItem Text="Male" Value="1" />
                                    <telerik:RadComboBoxItem Text="Female" Value="0" />
                                </Items>
                            </telerik:RadComboBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="rfv_Gender" runat="server" Text="*" InitialValue="Select"
                                ControlToValidate="rcmb_Gender" ErrorMessage="Please Select Gender" ValidationGroup="Controls"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                     <tr>
            <td>
    ...
    <asp:ValidationSummary ID="vs_LstofMaleFemaleEmpFrTheMnth" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>
