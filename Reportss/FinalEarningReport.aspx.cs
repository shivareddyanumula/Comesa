...
public partial class Reportss_FinalEarningReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                RPT_FinalEarning.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_FinalEarning.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "FinalEarningDetails";
                ...
                RPT_FinalEarning.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "FinalEarningReport", ex.StackTrace, DateTime.Now);
