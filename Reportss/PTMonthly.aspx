<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="PTMonthly.aspx.cs" Inherits="Reportss_PTMonthly" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU) {
            var win = window.radopen('../Reportss/PTMonthlyReport.aspx?PRD=' + url + '&ORG=' + ID + '&BU=' + BU, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("PT Monthly");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="PT Monthly Report" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_PTMonthly" runat="server" ShowMessageBox="true"
