<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="frm_DesgLogReportDaily.aspx.cs" Inherits="Reportss_frm_DesgLogReportDaily " %>
    ...
    <asp:UpdatePanel ID="up_Dailylogreport" runat="server">
        <ContentTemplate>
            <table align="center" width="990px" style="vertical-align: top;">
                <tr>
                    <td align="center">
                        <asp:Label ID="lbl_DailyLog" runat="server" Text="Designation wise Daily Log Report"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table align="center" style="width: 40%;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_Dept" runat="server" Text="Designation"></asp:Label>
                                </td>
                                <td>:
                                </td>
                                <td>
                                    <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_Position" runat="server" Skin="WebBlue" MarkFirstMatch="true"
                                        ...
                                        OnSelectedIndexChanged="rcmb_Position_SelectedIndexChanged">
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
                        </table>
