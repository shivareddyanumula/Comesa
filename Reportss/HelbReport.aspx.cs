...
public partial class Reportss_HelbReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                serverReport.ReportPath = MyReportPath + "Helb";
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "HelbReport", ex.StackTrace, DateTime.Now);
