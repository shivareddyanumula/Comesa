<%@ Page Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frm_AttendancePeriod.aspx.cs" Inherits="Masters_frm_AttendancePeriod" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        ...
        <tr>
            <td align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Attendance&nbsp;Period" Font-Bold="true"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <telerik:RadMultiPage ID="RMP_AttendancePeriod" runat="server" SelectedIndex="0">
                    <telerik:RadPageView ID="RPV_AttendancePeriod" runat="server" Selected="true">
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="rg_AttendancePeriod" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                                        GridLines="None" Skin="WebBlue" AllowFilteringByColumn="true"
                                        OnNeedDataSource="rg_AttendancePeriod_NeedDataSource">
                                        <MasterTableView CommandItemDisplay="Top">
                                            <Columns>
                                                <telerik:GridBoundColumn DataField="ATTENDANCEPERIOD_ID" UniqueName="ATTENDANCEPERIOD_ID" Visible="false"
                                                    HeaderText="ID" meta:resourcekey="ATTENDANCEPERIOD_ID">
                                                ...
                                                <telerik:GridBoundColumn DataField="ATTENDANCEPERIOD_STARTDATE" UniqueName="ATTENDANCEPERIOD_STARTDATE"
                                                    HeaderText="Start&nbsp;Date" meta:resourcekey="ATTENDANCEPERIOD_STARTDATE" DataFormatString="{0:d}">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="ATTENDANCEPERIOD_ENDDATE" UniqueName="ATTENDANCEPERIOD_ENDDATE"
                                                    HeaderText="End&nbsp;Date" meta:resourcekey="ATTENDANCEPERIOD_ENDDATE" DataFormatString="{0:d}">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </telerik:GridBoundColumn>
                                                <telerik:GridTemplateColumn UniqueName="ColEdit"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnk_Edit" runat="server" CommandArgument='<%# Eval("ATTENDANCEPERIOD_ID") %>'
                    ...
                    <telerik:RadPageView ID="RPV_AttendancePeriodDetails" runat="server">
                        <table align="center">
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="rcmb_PeriodDetails" runat="server" MarkFirstMatch="true" MaxHeight="120px" AutoPostBack="true" TabIndex="3" Filter="Contains"></telerik:RadComboBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td align="center" colspan="4">
                                    ...
                                    <asp:ValidationSummary ID="vs_AttendancePeriod" runat="server" ShowMessageBox="true" ShowSummary="false" ValidationGroup="Controls" />
                                </td>
                            </tr>
                        </table>
                    </telerik:RadPageView>
