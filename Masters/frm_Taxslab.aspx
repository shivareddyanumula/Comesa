<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="frm_Taxslab.aspx.cs" Inherits="Masters_frm_Taxslab" Culture="auto"
    UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <telerik:RadMultiPage ID="rmp_tax" runat="server" Height="450px" Width="1004px" SelectedIndex="0">
        <telerik:RadPageView ID="rpw_tax" runat="server">
            <table align="center" width="40%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox  ID="rtxt_Serial" runat="server"  Skin="WebBlue"  Enabled="false">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <telerik:RadNumericTextBox  ID="rntxt_FromValue" runat="server"  Skin="WebBlue" 
                            NumberFormat-DecimalDigits="2" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true"
                            IncrementSettings-Step="0" MaxLength="12" MinValue="0">
                        ...
                        <asp:RequiredFieldValidator ID="rfv_FromValue" runat="server" ControlToValidate="rntxt_FromValue"
                            Display="Dynamic" meta:resourcekey="rfv_FromValue" Text="*" ValidationGroup="Controls"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <telerik:RadNumericTextBox  ID="rntxt_ToValue" runat="server"  Skin="WebBlue" 
                            NumberFormat-DecimalDigits="2" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true"
                            IncrementSettings-Step="0" MaxLength="12" MinValue="0">
                            <IncrementSettings Step="0" />
                            <NumberFormat DecimalDigits="2" />
                        ...
                        <asp:RequiredFieldValidator ID="rfv_ToValue0" runat="server" ControlToValidate="rntxt_ToValue"
                            Display="Dynamic" meta:resourcekey="rfv_ToValue" Text="*" ValidationGroup="Controls"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <telerik:RadNumericTextBox  ID="rntxt_Value" runat="server"  Skin="WebBlue" 
                            NumberFormat-DecimalDigits="2" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true"
                            IncrementSettings-Step="0" MaxLength="12" MinValue="0">
                            <IncrementSettings Step="0" />
                            <NumberFormat DecimalDigits="2" />
                ...
                <tr>
                    <td colspan="3" align="center">
                        <asp:Button ID="btn_Include" runat="server" meta:resourcekey="btn_Include" OnClick="btn_Include_Click"/>
                        <asp:Button ID="btn_Update" runat="server" meta:resourcekey="btn_Update" Visible="false"
                ...
                <tr>
                    <td align="center" colspan="3">
                        <asp:CompareValidator ID="CmpValidator" runat="server" 
                            ControlToCompare="rntxt_FromValue" ControlToValidate="rntxt_ToValue" 
                            ErrorMessage="To value should be greater than From value" 
            ...
            <table align="center" width="50%">
                <tr>
                    <td>
                        <telerik:RadGrid  ID="RG_TaxSlab" runat="server" AllowPaging="true"  Skin="WebBlue" 
