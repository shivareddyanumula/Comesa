...
public partial class Reportss_SalaryJournalReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Salary Journal");
                ...
                else if (Convert.ToInt32(Session["WRITEFACILITY"]) == 2)
                {
                    smhr_UNAUTHORIZED _obj_smhr_unauthorized = new smhr_UNAUTHORIZED();
                    _obj_smhr_unauthorized.UNAUTHORIZED_USERID = Convert.ToInt32(Session["USER_ID"]);
                    _obj_smhr_unauthorized.UNAUTHORIZED_FORMID = Convert.ToInt32(ViewState["FORMS_ID"]);
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "SalaryJournalReport", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_SalaryReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_SalaryReport.ServerReport;
            //RPT_SalaryReport.AsyncRendering = false;
            //if (!RPT_SalaryReport.Enabled)
            //{
            //    RPT_SalaryReport.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "SalaryJournal";
            ...
            //RPT_SalaryReport.Visible = true;
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_payElements.SelectedValue) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "','" + Convert.ToString(rcb_Department.SelectedValue) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "SalaryJournalReport", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // RPT_SalaryReport.Visible = false;
