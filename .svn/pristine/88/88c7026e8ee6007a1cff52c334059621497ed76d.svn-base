...
public partial class Reportss_NnakReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                serverReport.ReportPath = MyReportPath + "NNAK";
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "NnakReport", ex.StackTrace, DateTime.Now);
