...
public partial class Reportss_ContractExpiry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Employee Data");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "ContractExpiry", ex.StackTrace, DateTime.Now);
    ...
    protected void rdpStartDate_OnSelectedDateChanged(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_Organisation.SelectedValue) + "','" + Convert.ToString(rcmb_BusinessUnit.SelectedValue) + "', '" + rdpStartDate.SelectedDate + "', '" + rdpEndDate.SelectedDate + "');", true);
