<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="GrsPayYrToDtByDept.aspx.cs" Inherits="Reportss_New_Reports_GrsPayYrToDtByDept" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(Org, BU, url, prddtl,sts) {
            var win = window.radopen('../NewReports/GrsPayYrToDtByDeptReport.aspx?ORG=' + Org + '&BU=' + BU + '&PRD=' + url + '&PRDDTL=' + prddtl+'&sts='+sts, "RadWindow1");
            win.center();
            win.set_modal(true);
           /////////////// win.set_width("670");
            win.set_title("Gross Pay Year To Date By Department");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Gross Pay Year to Date by Department" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_GrsPayYrToDtByDept" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>
