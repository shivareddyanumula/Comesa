...
public partial class Reportss_frmTerminated__Employees : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Terminated Employees");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "frmTerminated__Employees", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToInt32(Session["ORG_ID"]) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "','" + direct + "','" + Convert.ToString(rcm_Department.SelectedValue) + "','" + Convert.ToString(rd_FromDate.SelectedDate) + "','" + Convert.ToString(rd_ToDate.SelectedDate) + "');", true);
