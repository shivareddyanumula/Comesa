<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="Yearsinservice.aspx.cs" Inherits="Reportss_NEW_Yearsofservice" %>
    ...
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
     <script type="text/javascript">
         ...
         function ShowPop(Org, BU,emp,sts) {
          ////   var win = window.radopen('../NewReports/YearsinServiceReport.aspx?EMP=' + emp, "RadWindow1");
      var win = window.radopen('../NewReports/YearsinServiceReport.aspx?ORG=' + Org + '&BU=' + BU + '&EMP=' + emp+'&sts='+sts, "RadWindow1");
             win.center();
             win.set_modal(true);
             win.set_title("Years In Service Report");
     ...
     <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Years In Service" Font-Bold="true"
