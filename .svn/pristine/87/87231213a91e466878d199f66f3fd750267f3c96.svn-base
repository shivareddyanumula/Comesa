...
public partial class Reportss_ESICChalanaHUBLIReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_ESICChalanaHUBLI.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_ESICChalanaHUBLI.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "ESICChalanaHUBLI";
                ...
                Microsoft.Reporting.WebForms.ReportParameter[] parameters = { BusinessGroup, Period };
                serverReport.SetParameters(parameters);
                serverReport.Refresh();
                RPT_ESICChalanaHUBLI.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "ESICChalanaHUBLIReport", ex.StackTrace, DateTime.Now);
