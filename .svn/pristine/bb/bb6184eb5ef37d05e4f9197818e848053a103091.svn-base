      ...
      <Triggers>
                    ...
                    <telerik:RadPageView ID="RP_FORMVIEW" runat="server" 
                        ...
                        <table align="center" width="20%">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_Code" runat="server" Style="text-align: left" Text="Code:" 
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="rftxt_MasterCode" runat="server" ControlToValidate="rtxt_MasterCode"
                                        ErrorMessage="Please Specify Name" ValidationGroup="Controls" 
                                        meta:resourcekey="rftxt_MasterCode">*</asp:RequiredFieldValidator>
                                         <asp:RegularExpressionValidator ID="rev_rtxt_MasterCode" runat="server" ControlToValidate="rtxt_MasterCode" ErrorMessage="Enter only Alphabets for Name" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="rftxt_MasterDesc" runat="server" ControlToValidate="rtxt_MasterDesc" ErrorMessage="Please Specify Name" ValidationGroup="Controls" Text="*" Enabled="false"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
