...
public partial class Reportss_StaffWelfareFundReports : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                serverReport.ReportPath = MyReportPath + "StaffWelfareFund";
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "StaffWelfareFundReports", ex.StackTrace, DateTime.Now);
