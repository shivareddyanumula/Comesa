...
public partial class Reportss_OverTime : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "OverTime", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_OverTimeReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_OverTimeReport.ServerReport;
            //RPT_OverTimeReport.AsyncRendering = false;
            //if (!RPT_OverTimeReport.Enabled)
            //{
            //    RPT_OverTimeReport.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "OverTime";
            ...
            //RPT_OverTimeReport.Visible = true;
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_OverTimeReport.Visible = false;
            ddl_BusinessUnit.SelectedIndex = 0;
