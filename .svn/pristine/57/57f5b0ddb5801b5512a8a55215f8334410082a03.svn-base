...
public partial class Reportss_AttendanceReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
       {
        if (!Page.IsPostBack)
        {
            ...
            if (loanType == "MonthWiseEmpNotPaid")
            {
                lbl_Header.Text = "Month Wise Employee Not Paid";
            }
            else
            {
                lbl_Header.Text = "Attendance";
            }
        }
        Page.Validate();
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("AttendanceReport");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "AttendanceReport", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_Attendance.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_Attendance.ServerReport;
            ...
            //serverReport.ReportPath = MyReportPath + "AttendanceReport";
            ...
            //{
            //    Period = new Microsoft.Reporting.WebForms.ReportParameter("Period", rcmb_payElements.SelectedValue);
            //}
            //else
            //{
            ...
            //RPT_Attendance.Visible = true;

            //To show Month Wise Employee Not Paid
            string loanType = string.Empty;
            if (Request.QueryString.HasKeys())
            {
                loanType = Convert.ToString(Request.QueryString["LoanType"]);
            ...
            {
                //lbl_Header.Text = "Month Wise Employee Not Paid";
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPopup('" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "','" + Convert.ToString(rcmb_payperiod.SelectedValue) + "','" + Convert.ToString(rcmb_payElements.SelectedValue) + "');", true);
                return;
            }
            else
            {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rcmb_payElements.SelectedValue) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "AttendanceReport", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_BarclaysBankLoan.Visible = false;
