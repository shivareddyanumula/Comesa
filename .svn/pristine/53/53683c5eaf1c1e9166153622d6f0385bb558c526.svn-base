                            ...
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="Rg_Mamager" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        Skin="WebBlue" OnItemCreated="Rg_Mamager_ItemCreated"
                                        OnNeedDataSource="Rg_Mamager_NeedDataSource" AllowPaging="True" PageSize="20"
                                        Width="900px" OnDataBinding="Rg_Mamager_DataBinding"
