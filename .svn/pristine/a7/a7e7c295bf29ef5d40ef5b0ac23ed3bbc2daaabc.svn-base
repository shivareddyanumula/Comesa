...
public partial class Reportss_BankStatementReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                serverReport.ReportPath = MyReportPath + "Salary Report";
                ...
                if (Convert.ToString(Request.QueryString["Sts"]) != null)
                {
                ...
                rpt_BankStatement.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "BankStatementReport", ex.StackTrace, DateTime.Now);
