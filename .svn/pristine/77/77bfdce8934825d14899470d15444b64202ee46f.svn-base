<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="MedicalBenfitClaimEmp.aspx.cs" Inherits="Selfservice_MedicalBenfitClaimEmp" %>
                                                    ...
                                                    <CommandItemTemplate>
                                                        <div align="right">
                                                            <asp:LinkButton ID="lnk_Self" runat="server" meta:resourceKey="lnk_Add" CommandArgument="Self" Visible="false"
                                                                OnCommand="lnk_Add_Command" Font-Bold="true">Self Claim</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                                            <asp:LinkButton ID="lnk_Family" runat="server" meta:resourceKey="lnk_Add" CommandArgument="Family" Visible="false"
                            ...
                            <ContentTemplate>
                                <table align="center" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <telerik:RadComboBox ID="rcmb_Employee" runat="server" MarkFirstMatch="true" Enabled="false" Filter="Contains"
                                                AutoPostBack="true" MaxHeight="200" OnSelectedIndexChanged="rcmb_Employee_SelectedIndexChanged">
                                            </telerik:RadComboBox>
                                            <asp:RequiredFieldValidator ID="rfv_rcmb_Employee" runat="server" Text="*" InitialValue="Select"
                                                ControlToValidate="rcmb_Employee" ValidationGroup="Controls" Display="Dynamic" ErrorMessage="Please Select Employee"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="RadClaimType" runat="server" AutoPostBack="True"
                                                OnSelectedIndexChanged="RadClaimType_SelectedIndexChanged" 
                                                EmptyMessage="Select">
                                                <Items>
                                ...
                                <td colspan="3" align="left">
                                    ...
                                    <tr id="trBenficaryName" runat="server">
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="radBenficaryName" runat="server" AutoPostBack="True" Filter="Contains"
                                                OnSelectedIndexChanged="radBenficaryName_SelectedIndexChanged" EmptyMessage="Select">
                                            </telerik:RadComboBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="RadServiceProviderName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="RadServiceProviderName_SelectedIndexChanged"
                                    ...
                                    <tr>
                                        <td align="center" colspan="3">
                                            <asp:Button ID="btnFinalize" runat="server" OnClick="btn_Save_Click"
                                                Text="Finalize" Visible="False" ValidationGroup="Controls" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
