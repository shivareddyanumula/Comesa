<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="Nssf.aspx.cs" Inherits="Reportss_Nssf" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //    var win = window.radopen('../Reportss/Nssf_report.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
        function ShowPop(BU, DIR, DEP, PRD, PE, sts) {
            var win = window.radopen('../Reportss/Nssf_report.aspx?BU=' + BU + '&DIR=' + DIR + '&DEPT=' + DEP + '&PRD=' + PRD + '&PE=' + PE + '&Sts=' + sts, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("NSSF");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="NSSF Report" Font-Bold="True" Font-Names="Arial"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payElements" runat="server" MarkFirstMatch="true" Filter="Contains"
                    MaxHeight="200px" Skin="WebBlue" AutoPostBack="True" OnSelectedIndexChanged="rcmb_payElements_SelectedIndexChanged">
                </telerik:RadComboBox>
            </td>
            <td>
    ...
    <table align="center">
        <tr>
            <td>
                <rsweb:ReportViewer ID="RPT_Nssf" runat="server" ShowParameterPrompts="false" Width="900px"
                    Height="400px" ProcessingMode="Remote">
                </rsweb:ReportViewer>
            </td>
        </tr>
    </table>
