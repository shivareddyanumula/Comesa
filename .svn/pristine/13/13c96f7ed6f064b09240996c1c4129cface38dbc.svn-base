...
public partial class Reportss_StaffWelfareLoanReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                RPT_WElfareLoan.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_WElfareLoan.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "StaffWelfareLoan";
                ...
                RPT_WElfareLoan.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "StaffWelfareLoanReport", ex.StackTrace, DateTime.Now);
