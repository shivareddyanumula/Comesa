<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EducationalClaimReport.aspx.cs" Inherits="Reportss_NewReports_Default" %>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <rsweb:ReportViewer ID="RPT_Ec" runat="server" Height="518px" Width="950px"
