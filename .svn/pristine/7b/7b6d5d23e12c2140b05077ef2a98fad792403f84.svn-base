<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="IncrementReport.aspx.cs" Inherits="Reportss_IncrementReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />

    <script type="text/javascript">
        function ShowPop(url, ID, BU, status, prddtl) {
            var win = window.radopen('../Reportss/IncrementReportReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + '&GRA=' + status + '&PRDDTL=' + prddtl, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Increment");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Increment Report" Font-Bold="true"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfv_Organisation" runat="server" Text="*" ControlToValidate="rcmb_Organisation"
                    ErrorMessage="Select Organisation" ValidationGroup="Controls">
        ...
        <tr>
            <td>
                <asp:Label ID="lbl_Grade" runat="server" Text="Grade">
                </asp:Label>
            </td>
            <td>
                <b>:</b>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_Grade" runat="server" AutoPostBack="true" MarkFirstMatch="true" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="rfv_Grade" runat="server" InitialValue="Select" Text="*"
                    ValidationGroup="Controls" ErrorMessage="Select Grade" ControlToValidate="rcmb_Grade">
                </asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
    ...
    <asp:ValidationSummary ID="vs_IncrementReport" runat="server" ShowMessageBox="true"
