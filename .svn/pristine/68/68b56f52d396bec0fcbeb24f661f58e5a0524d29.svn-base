<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="Turnover Periods Analysis.aspx.cs" Inherits="Reportss_Turnover_Periods_Analysis" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, url1, ID, status, sal) {
            var win = window.radopen('../Reportss/TurnOverPeriodAnalysisReport.aspx?PRD=' + url + '&PRD1=' + url1 + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("TurnOver By Period Analysis Report");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Turn Over Rate By Period Analysis Report" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="ddl_Department" runat="server" MarkFirstMatch="true" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td>&nbsp;
            </td>
    ...
    <br />
    <%-- <center>
        <rsweb:ReportViewer ID="RPT_TurnoverPeriodsAnalysisReport" runat="server" Width="950px"
