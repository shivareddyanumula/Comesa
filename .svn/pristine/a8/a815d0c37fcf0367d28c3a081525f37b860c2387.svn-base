<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="EmployeeSalaryRegister.aspx.cs" Inherits="Reportss_EmployeeSalaryRegister" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

    <script type="text/javascript">
        function ShowPop(url, ID, BU, prddtl, emp) {
            var win = window.radopen('../Reportss/EmployeeSalaryRegisterReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + '&prddtl=' + prddtl + '&emp=' + emp, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Employee Salary Register");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Employee Salary Register Report" Font-Bold="true"
        ...
        <tr id="trEmployee" runat="server" visible="false">
            ...
            <td>
                <telerik:RadComboBox ID="rcmbEmployee" runat="server" MarkFirstMatch="true" Filter="Contains" OnSelectedIndexChanged="rcmbEmployee_SelectedIndexChanged" AutoPostBack="true">
                </telerik:RadComboBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="rfvEmployee" runat="server" InitialValue="Select"
                    Text="*" ControlToValidate="rcmbEmployee" ErrorMessage="Please Select Employee" ValidationGroup="Controls"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_Period" runat="server" MarkFirstMatch="true" AutoPostBack="true"
    ...
    <asp:ValidationSummary ID="vs_PayRegister" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>