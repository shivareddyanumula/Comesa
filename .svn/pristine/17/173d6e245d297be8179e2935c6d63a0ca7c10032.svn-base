<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="EmployeeData.aspx.cs" Inherits="Reportss_EmployeeData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(ID, BU, SD, ED) {
            var win = window.radopen('../Reportss/EmployeeDataReport.aspx?ORG_ID=' + ID + '&BU=' + BU + '&SD=' + SD + '&ED=' + ED, "RadWindow1");
            win.center();
            win.set_modal(true);
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Employee Data Report" Font-Bold="true"
