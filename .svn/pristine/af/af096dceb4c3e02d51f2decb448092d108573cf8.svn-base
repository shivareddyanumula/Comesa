...
public partial class Reportss_Co_OperativeBankLoan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Co-Operative Bank Loan");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Co_OperativeBankLoan", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_CoOperativeBankLoan.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_CoOperativeBankLoan.ServerReport;
            //RPT_CoOperativeBankLoan.AsyncRendering = false;
            //if (!RPT_CoOperativeBankLoan.Enabled)
            //{
            //    RPT_CoOperativeBankLoan.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "Co-OperativeBankLoan";
            ...
            //RPT_CoOperativeBankLoan.Visible = true;
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_CoOperativeBankLoan.Visible = false;
