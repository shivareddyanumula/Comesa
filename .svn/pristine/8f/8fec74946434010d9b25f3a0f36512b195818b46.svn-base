<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SMHRMaster.master" CodeFile="frm_EmpBankTransactions.aspx.cs" Inherits="Reportss_frm_EmpBankTransactions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(url, ID, prdele) {
            var win = window.radopen('../Reportss/frm_EmpBankTransactionsReport.aspx?PRD=' + url + '&BU=' + ID + '&PRDELE=' + prdele, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Employee Bank Transaction");
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Employee Bank Transaction Report" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="rcmb_Organisation"
                    ErrorMessage="Please Select Oraganisation" InitialValue="Select" ValidationGroup="Controls">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
