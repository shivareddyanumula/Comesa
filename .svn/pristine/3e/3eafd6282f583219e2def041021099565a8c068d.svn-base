...
public partial class Reportss_Re_Hired_Employees_Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Re-Hired Employees Report");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Re-Hired Employees Report", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //    RPT_ReHiredEmployeesReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //    Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //    serverReport = RPT_ReHiredEmployeesReport.ServerReport;
            //    RPT_ReHiredEmployeesReport.AsyncRendering = false;
            //    if (!RPT_ReHiredEmployeesReport.Enabled)
            //    {
            //        RPT_ReHiredEmployeesReport.CurrentPage = 1;
            //    }
            ...
            //    serverReport.ReportPath = "/SmartHR Kenya MT/" + "ReHiredEmployees";
            ...
            //    {
            //        Period = new Microsoft.Reporting.WebForms.ReportParameter("Period", rd_FromDate.SelectedDate.Value.ToShortDateString());
            //    }
            //    else
            //    {
            ...
            //    Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Organisation, BusinessGroup, Department, Period };
            //    serverReport.SetParameters(parameters);
            //    serverReport.Refresh();
            //    RPT_ReHiredEmployeesReport.Visible = true;

            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ShowPop('" + Convert.ToString(rd_FromDate.SelectedDate) + "','" + Convert.ToString(ddl_BusinessUnit.SelectedValue) + "','" + Convert.ToString(ddl_Department.SelectedValue) + "');", true);
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "Re-Hired Employees Report", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_ReHiredEmployeesReport.Visible = false;
