...
public partial class Reportss_Pms_AppraisalDoneReport : System.Web.UI.Page
{
    ...
    //    Warning[] warnings;
    //    string[] streamids;
    //    byte[] exportBytes = RPT_AppraisalDoneReport.ServerReport.Render("EXCEL", null, out mimeType, out encoding, out fileNameExtension, out streamids, out warnings);
