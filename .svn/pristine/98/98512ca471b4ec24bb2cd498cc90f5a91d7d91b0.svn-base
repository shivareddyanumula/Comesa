<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frmPreProvisionalPending.aspx.cs" Inherits="Reportss_frmPreProvisionalPending" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, prddtl, emp, BU, Localisation) {
            var win = window.radopen('../Reportss/frmPreProvisionalPendingReport.aspx?PRD=' + url + '&PRDDTL=' + prddtl + '&EMP=' + emp + '&BU=' + BU + '&Localisation=' + Localisation, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_width("670");
            win.set_title("Pre-Provisional Pay Slip for All");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Pre-Provisional Pay Slip for All" Font-Bold="true"
            ...
            <td>
                <table align="center" style="width: 32%;">
                    ...
                    <asp:Panel runat="server" ID="pnlEmp" Visible="false">
                        <tr id="trRblist" runat="server" visible="false">
                            <td>
                    ...
                    <tr id="tr_Employee1" runat="server">
                        <td colspan="4" style="text-align: center">
                            ...
                            <asp:ValidationSummary ID="vs_ProvisionalSlip" runat="server" ShowMessageBox="true"
    ...
    <div>
        <telerik:RadWindow runat="server" ID="rwPreAprPaySlip" VisibleOnPageLoad="false" Height="518px"
            ...
            <ContentTemplate>
                <rsweb:ReportViewer ID="RPT_ProvisionalSlip" runat="server" Height="518px" Width="950px"
