...
public partial class Reportss_EmployeeMonthly : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Employee Monthly");
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_EmployeeMonthltyReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_EmployeeMonthltyReport.ServerReport;
            //RPT_EmployeeMonthltyReport.AsyncRendering = false;
            //if (!RPT_EmployeeMonthltyReport.Enabled)
            //{
            //    RPT_EmployeeMonthltyReport.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "EmployeeMonthly";
            ...
            //{
            //    FromDate = new Microsoft.Reporting.WebForms.ReportParameter("FromDate", rd_FromDate.SelectedDate.Value.ToShortDateString());
            //}
            //else
            //{
            ...
            //{
            //    ToDate = new Microsoft.Reporting.WebForms.ReportParameter("ToDate", rd_ToDate.SelectedDate.Value.ToShortDateString());
            //}
            //else
            //{
            ...
            //Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Organisation,BusinessGroup,Department,FromDate,ToDate };
            //serverReport.SetParameters(parameters);
            //serverReport.Refresh();
            //RPT_EmployeeMonthltyReport.Visible = true;
