<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="FrmReport1.aspx.cs" Inherits="Reportss_FrmReport1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />

    <script type="text/javascript">
        function ShowPop(BU, str) {
            var win = window.radopen('../Reportss/FrmReport1Data.aspx?BU=' + BU + '&rptStr=' + str, "RadWindow1");
            win.center();
            win.set_modal(true);
