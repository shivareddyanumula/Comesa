<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChngsToBasicPayByCmpnyTtlReport.aspx.cs" Inherits="Reportss_New_Reports_ChngsToBasicPayByCmpnyTtlReport" %>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <rsweb:ReportViewer ID="RPT_ChngsToBasicPayByCmpnyTtl" runat="server" Height="518px" Width="950px"
