<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="Default3" %>
                    ...
                    <telerik:RadPageView ID="Rp_Course_ViewDetails" runat="server">
                        <table align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="radCourseType" runat="server" Skin="WebBlue" MarkFirstMatch="true" MaxHeight="120px" TabIndex="2" Filter="Contains">
                                    </telerik:RadComboBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadNumericTextBox ID="radSessions" runat="server" Skin="WebBlue" NumberFormat-GroupSeparator="" NumberFormat-DecimalDigits="0" TabIndex="5">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="radBatchDetail" runat="server" Skin="WebBlue" NumberFormat-GroupSeparator="" NumberFormat-DecimalDigits="0" TabIndex="12">
                                    </telerik:RadTextBox>
