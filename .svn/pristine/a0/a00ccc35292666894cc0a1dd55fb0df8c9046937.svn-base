...
public partial class Reportss_EmployeePayHistoryReportaspx : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_EmployeePayHistory.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_EmployeePayHistory.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "EmployeePayHistory";
                ...
                RPT_EmployeePayHistory.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EmployeePayHistoryReport", ex.StackTrace, DateTime.Now);
