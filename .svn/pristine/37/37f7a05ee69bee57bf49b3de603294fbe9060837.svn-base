<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="frmTerminated_Employees.aspx.cs" Inherits="Reportss_frmTerminated__Employees" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(org, buid, derict, depart, frmdate, Tdate) {
            debugger
            var win = window.radopen('../Reportss/Frm_TerminatedEmployeesReport.aspx?OG=' + org + '&BU=' + buid + '&DER=' + derict + '&DEP=' + depart + '&FMDATE=' + frmdate + '&TDAT=' + Tdate, "RadWindow1");
            win.center();
            win.set_modal(true);
        ...
        <table align="center">
            ...
            <tr>
                <td colspan="4" align="center">
                    <asp:Label ID="lb_Header" runat="server" Text="Terminated Employees" Font-Bold="True" Visible="true"
