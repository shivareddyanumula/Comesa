<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="LOP.aspx.cs" Inherits="Reportss_LOPReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(url, ID, BU, prddtl) {
            var win = window.radopen('../Reportss/LOPReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + '&PRDDTL=' + prddtl, "RadWindow1");
            win.center();
            win.set_modal(true);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="LOP Report" Font-Bold="true" Font-Size="11pt"
        ...
        <td>
        <telerik:RadComboBox ID="rcmb_Employee" runat="server" 
         AutoPostBack="true">
         </telerik:RadComboBox>
        </td>
        <td></td>
        ...
        <tr>
            <td>
                <asp:Label ID="lbl_PeriodElemtents" runat="server" Text="Period Elements">
                </asp:Label>
            </td>
            <td>
                <b>:</b>
    ...
    <asp:ValidationSummary ID="vs_LOP" runat="server" ShowMessageBox="true" ShowSummary="false"
        ValidationGroup="Controls" />
</asp:Content>