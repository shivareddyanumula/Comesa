...
public partial class Reportss_EmployeeAge : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Employee Age");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "EmployeeAge", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            // RPT_EmployeeAgeReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            // Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            // serverReport = RPT_EmployeeAgeReport.ServerReport;
            // RPT_EmployeeAgeReport.AsyncRendering = false;
            // if (!RPT_EmployeeAgeReport.Enabled)
            // {
            //     RPT_EmployeeAgeReport.CurrentPage = 1;
            // }
            ...
            // serverReport.ReportPath = "/SmartHR Kenya MT/" + "Employees_Age_Report";
            ...
            //  Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Period, BusinessGroup, Department ,Organisation};
            // serverReport.SetParameters(parameters);
            // serverReport.Refresh();
            // RPT_EmployeeAgeReport.Visible = true;
    ...
    protected void btn_Cancel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //RPT_EmployeeAgeReport.Visible = false;
