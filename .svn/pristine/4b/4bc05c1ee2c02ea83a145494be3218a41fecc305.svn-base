<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="EmployeeDetails.aspx.cs" Inherits="Reportss_EmployeeDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(ID, BU, SD, ED) {
            var win = window.radopen('../Reportss/EmployeeDetailsReport.aspx?ORG_ID=' + ID + '&BU=' + BU + '&SD=' + SD + '&ED=' + ED, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Employee Details Report");
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Employee Details Report" Font-Bold="true"
