<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="EmployeeLeaveDetail.aspx.cs" Inherits="Reportss_EmployeeLeaveDetail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID) {
            var win = window.radopen('../Reportss/EmployeeLeaveDetailReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + ID + '&EMP=' + ID, "RadWindow1");
            win.center();
            win.set_modal(true);
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Employee Leave Detail Report" Font-Bold="true"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_Organisation" runat="server" EnableEmbeddedSkins="false"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_PeriodElements" runat="server" AutoPostBack="true" MarkFirstMatch="true"
                    EnableEmbeddedSkins="false" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td></td>
        </tr>
