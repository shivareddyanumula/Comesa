<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="CurrentEmpContractdetails.aspx.cs" Inherits="Reportss_NEW_CurrentEmpContractdetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(Org, BU, emp,sts) {
            var win = window.radopen('../NewReports/CurrentEmpContractdetailsReport.aspx?ORG=' + Org + '&BU=' + BU + '&EMP=' + emp+'&sts='+sts, "RadWindow1");
            win.center();
           /////////// win.set_modal(true);
            win.set_title("Current Employee Contract Details");
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Current Employee Contract Details" Font-Bold="true"
