<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="AnnualEmployeeIncomeBracket.aspx.cs" Inherits="Reportss_AnnualEmployeeIncomeBracket" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(BU) {
            var win = window.radopen('../Reportss/AnnualEmployeeIncomeBracketReport.aspx?BU=' + BU, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Annual Employee Income Bracket Report");
