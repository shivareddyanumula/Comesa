<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="PayRegisterAnnual.aspx.cs" Inherits="Reportss_PayRegisterAnnual" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU) {
            var win = window.radopen('../Reportss/PayRegisterAnnualReport.aspx?PRD=' + url + '&ORG=' + ID + '&BU=' + BU, "RadWindow1");
            win.center();
            win.set_modal(true);
