...
public partial class Reportss_MonthlyEmployeeIncomeBracketReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_MonthlyEmployeeIncomeBracketReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_MonthlyEmployeeIncomeBracketReport.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "MonthlyEmployeeIncomeBracket";
                ...
                Microsoft.Reporting.WebForms.ReportParameter[] parameters = { Organisation, Period, BusinessGroup, PeriodElement };
                serverReport.SetParameters(parameters);
                serverReport.Refresh();
                RPT_MonthlyEmployeeIncomeBracketReport.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "MonthlyEmployeeIncomeBracketReport", ex.StackTrace, DateTime.Now);
