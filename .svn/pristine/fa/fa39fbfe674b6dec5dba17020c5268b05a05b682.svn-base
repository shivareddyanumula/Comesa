...
public partial class HR_Employees : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      try
      {
        if (!Page.IsPostBack)
        {
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("EMPLOYEE AX");
    ...
    protected void btn_Get_Details_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = BLL.ExecuteQuery("EXEC USP_SMHR_EMP_AX @FROMPERIOD ='" + Convert.ToDateTime(rdp_FromDate.SelectedDate.Value) + "', @TOPERIOD='" + Convert.ToDateTime(rdp_ToDate.SelectedDate.Value) + "',@ORG_ID = '" + Convert.ToInt32(Session["ORG_ID"]) + "'");
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                {
                    FileName1 = "~//XML//CIL_SMHR_MST_" + DateVal + "_" + dt_1.Rows[0]["MASTERNO"] + ".xml";
                ...
                {
                    FileName1 = "~//XML//CIL_SMHR_MST_" + DateVal + "_1.xml";
                    partyno = 0;
                }
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    myXmlTextWriter.WriteElementString("PartyId", null, Convert.ToString(partyno));
                    myXmlTextWriter.WriteElementString("status", null, Convert.ToString(dt.Rows[i]["STATUS"]));
