...
public partial class Reportss_StaffWelfareFundReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Staff Welfare Fund");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "StaffWelfareFundReport", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //RPT_WElfareTax.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //serverReport = RPT_WElfareTax.ServerReport;
            //RPT_WElfareTax.AsyncRendering = false;
            //if (!RPT_WElfareTax.Enabled)
            //{
            //    RPT_WElfareTax.CurrentPage = 1;
            //}
            ...
            //serverReport.ReportPath = "/SmartHR Kenya MT/" + "StaffWelfareFundReport";
