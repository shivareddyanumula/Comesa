...
public partial class Reportss_PmsAppraisalOpenReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_AppraisalOpenReport.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_AppraisalOpenReport.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "Appraisal Open";
                ...
                RPT_AppraisalOpenReport.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "PmsAppraisalOpenReport", ex.StackTrace, DateTime.Now);
    ...
    //    Warning[] warnings;
    //    string[] streamids;
    //    byte[] exportBytes = RPT_AppraisalOpenReport.ServerReport.Render("EXCEL", null, out mimeType, out encoding, out fileNameExtension, out streamids, out warnings);
