<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="PayRegisterRow.aspx.cs" Inherits="Reportss_PayRegisterRow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(url, ID, BU, PRDDTL, paytran) {
            var win = window.radopen('../Reportss/PayRegisterRowReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + ' &PRDDTL=' + PRDDTL + '&PAYTRAN=' + paytran, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Pay Register Row");
