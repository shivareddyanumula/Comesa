<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="LeaveApplication.aspx.cs" Inherits="Reportss_LeaveApplication" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU, prddtl) {
            var win = window.radopen('../Reportss/LeaveApplicationReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + '&PRDDTL=' + prddtl, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Leave Application Report");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Leave Application Report" Font-Bold="true"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_Organisation" runat="server" AutoPostBack="true" MarkFirstMatch="true"
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfv_Organisation" runat="server" InitialValue="Select" Text="*"
                    ControlToValidate="rcmb_Organisation" ErrorMessage="Select Organisation" ValidationGroup="Controls"
                    Enabled="false">
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_PeriodElements" runat="server" MarkFirstMatch="true"
                    AutoPostBack="false" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td>
    ...
    <asp:ValidationSummary ID="vs_LeaveApplication" runat="server" ShowMessageBox="true"
