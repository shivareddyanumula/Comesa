<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CurrentEmpContractdetailsReport.aspx.cs" Inherits="Reportss_NEW_CurrentEmpContractdetailsReport" %>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <rsweb:ReportViewer ID="RPT_Cecd" runat="server" Height="518px" Width="950px"
