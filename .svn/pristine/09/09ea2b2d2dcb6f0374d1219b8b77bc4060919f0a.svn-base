<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="EmployeeMonthly.aspx.cs" Inherits="Reportss_EmployeeMonthly" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, url1, ID, status) {
            var win = window.radopen('../Reportss/EmployeeMonthlyReoprt.aspx?PRD=' + url + '&PRD1=' + url1 + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Employee Monthly Report");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Employee Monthly Report" Font-Bold="True"
    ...
    <br />
    <%-- <center>
        <rsweb:ReportViewer ID="RPT_EmployeeMonthltyReport" runat="server" Width="950px" Height="518px"
