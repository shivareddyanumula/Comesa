...
public partial class Reportss_LeaveEncashmentReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_LeaveEncashment.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_LeaveEncashment.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "EmployeeLeaveEncashment";
                ...
                RPT_LeaveEncashment.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "LeaveEncashmentReport", ex.StackTrace, DateTime.Now);
