<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="Form10A.aspx.cs" Inherits="Reportss_Form10A" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU, emp) {
            var win = window.radopen('../Reportss/Form10AReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Form 10A");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Form10A Report" Font-Bold="true"
    ...
    <asp:ValidationSummary ID="vs_Form10A" runat="server" ShowMessageBox="true"
