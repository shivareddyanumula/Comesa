<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="PaySlip.aspx.cs" Inherits="Reportss_PaySlip" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU, emp) {
            var win = window.radopen('../Reportss/PaySlipReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + '&EMP=' + emp, "RadWindow1");
            win.center();
            win.set_modal(true);
