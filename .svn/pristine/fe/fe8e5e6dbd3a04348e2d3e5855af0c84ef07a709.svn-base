...
public partial class Reportss_BarclaysBankLoan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                _obj_Smhr_LoginInfo.LOGIN_PASS_CODE = Convert.ToString("Barclays Bank Loan");
        ...
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "BarclaysBankLoan", ex.StackTrace, DateTime.Now);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            //    RPT_BarclaysBankLoan.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
            //    Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
            //    serverReport = RPT_BarclaysBankLoan.ServerReport;

            //    RPT_BarclaysBankLoan.AsyncRendering = false;
            //    if (!RPT_BarclaysBankLoan.Enabled)
            //    {
            //        RPT_BarclaysBankLoan.CurrentPage = 1;
            //    }
            ...
            //    serverReport.ReportPath = "/SmartHR Kenya MT/" + "BarclaysBankLoan";
            ...
            //    RPT_BarclaysBankLoan.Visible = true;
