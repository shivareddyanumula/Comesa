<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true"
    CodeFile="Vacancy.aspx.cs" Inherits="Reportss_Vacancy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function ShowPop(ID, BU) {
            var win = window.radopen('../Reportss/VacancyReport.aspx?ORG_ID=' + ID + '&BU=' + BU, "RW_Vacancy");
            win.center();
            win.set_modal(true);
            win.set_title("Vacancy Report");
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Vacancy" Font-Bold="true" Font-Size="11pt"
