<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="Sacco.aspx.cs" Inherits="Reportss_Sacco" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/SaccoReport.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Sacco");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Sacco Report" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                    ControlToValidate="ddl_BusinessUnit" ErrorMessage="Please select Business Unit"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="rcmb_payElements" runat="server" Skin="WebBlue"
                    AutoPostBack="True" MaxHeight="200px" MarkFirstMatch="true"
                    OnSelectedIndexChanged="rcmb_payElements_SelectedIndexChanged" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td>
    ...
    <br />
    <%--<center>
        <rsweb:ReportViewer ID="RPT_Sacco" runat="server" Width="950px" Height="518px"
