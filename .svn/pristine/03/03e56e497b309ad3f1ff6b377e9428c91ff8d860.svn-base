<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="BasicPayToDate.aspx.cs" Inherits="Reportss_New_Reports_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function ShowPop(Org,BU,url,prddtl,sts) {
            ...
            var win = window.radopen('../NewReports/BasicPayToDateReport.aspx?ORG=' + Org + '&BU=' + BU + '&PRD=' + url + '&PRDDTL=' + prddtl +'&sts='+sts , "RadWindow1");
            win.center();
            win.set_modal(true);
         //////   win.set_width("400");
            win.set_title("Basic Pay To Date");
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Basic Pay To Date" Font-Bold="true"
