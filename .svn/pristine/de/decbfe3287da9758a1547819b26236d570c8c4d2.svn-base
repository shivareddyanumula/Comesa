<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="Co-OperativeBankLoan.aspx.cs" Inherits="Reportss_Co_OperativeBankLoan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, status, sal) {
            var win = window.radopen('../Reportss/Co-OperativeBankLoanReport.aspx?PRD=' + url + '&BU=' + ID + '&DEPT=' + status, "RadWindow1");
            win.center();
            win.set_modal(true);
            win.set_title("Co-operative Bank Loan");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_Header" runat="server" Text="Co-Operative Bank Loan Report" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox EnableEmbeddedSkins="false" ID="ddl_BusinessUnit" runat="server" AutoPostBack="True" Filter="Contains"
                    OnSelectedIndexChanged="ddl_BusinessUnit_SelectedIndexChanged" MarkFirstMatch="true">
                </telerik:RadComboBox>
            </td>
            <td>&nbsp;</td>
        </tr>
    ...
    <br />
    <%--  <center>
        <rsweb:ReportViewer ID="RPT_CoOperativeBankLoan" runat="server" Width="950px" Height="518px"
