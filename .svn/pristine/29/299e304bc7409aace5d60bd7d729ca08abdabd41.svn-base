<%@ Page Title="" Language="C#" MasterPageFile="~/SMHRMaster.master" AutoEventWireup="true" CodeFile="PayslipMODIFIED.aspx.cs" Inherits="Reportss_PaySlip" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../smhr.css" rel="Stylesheet" type="text/css" />
    <script type="text/javascript">
        function ShowPop(url, ID, BU, dept, emp) {
            var win = window.radopen('../Reportss/PaySlipReport.aspx?PRD=' + url + '&ORG_ID=' + ID + '&BU=' + BU + '&DEPT=' + dept + '&EMP=' + emp, "RadWindow1");
            win.center();
            win.set_modal(true);
    ...
    <table align="center">
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="lbl_header" runat="server" Text="Pay Slip Report" Font-Bold="true"
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="rcmb_Department" runat="server" MarkFirstMatch="true"
                    AutoPostBack="true" Filter="Contains">
                </telerik:RadComboBox>
            </td>
            <td></td>
