<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SMHRMaster.master" CodeFile="frm_Valuesform.aspx.cs" Inherits="PMS_frm_Valuesform" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDefault" runat="Server">
    <table align="center">
        ...
        <tr>
            <td align="center">
                <asp:Label ID="lbl_VAL" runat="server" Text="Values" Font-Bold="true"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <telerik:RadMultiPage ID="RM_VALUESform" runat="server">
                    <telerik:RadPageView ID="RP_VALUESform" runat="server">
                        <table align="center">
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="RG_VALUESform" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                        PageSize="5" Skin="WebBlue" GridLines="None" AllowFilteringByColumn="True" OnNeedDataSource="RG_valuesform_NeedDataSource"
                                        Width="900px">
                                        <MasterTableView CommandItemDisplay="Top">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn HeaderText="VAL ID" DataField="IDP_ID" UniqueName="column11"
                                                    meta:resourcekey="GridBoundColumnResource11" Visible="false">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn HeaderText="Value Name" DataField="IDP_NAME" UniqueName="column"
                                                    meta:resourcekey="GridBoundColumnResource1">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn HeaderText="Description" DataField="IDP_DESCRIPTION" UniqueName="column1"
                                                    meta:resourcekey="GridBoundColumnResource2">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn HeaderText="Status" DataField="IDP_STATUS" UniqueName="column12"
                                                    meta:resourcekey="GridBoundColumnResource2">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn" meta:resourcekey="GridTemplateColumnResource1">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnk_Edit" runat="server" OnCommand="lnk_Edit_Commnad" CommandArgument='<%# Eval("IDP_ID") %>'
                    ...
                    <telerik:RadPageView ID="RP_valuesformview2" runat="server" Width="100%">
                        <table align="center">
                            <tr>
                                <td align="center" colspan="4">
                                    <asp:Label ID="lbl_VALdet" runat="server" Text="" Font-Bold="true"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                            ...
                            <tr>
                                <td style="text-align: left">
                                    ...
                                    <asp:Label ID="lbl_valname" runat="server" Text="Value Name" Style="text-align: left; font-family: Arial, Helvetica, sans-serif; font-size: small;"></asp:Label>
                                </td>
                                <td>
                                    <b>:</b>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_valname" runat="server" MaxLength="1000" Width="200px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_valname"
                                        ErrorMessage="Please Enter Value Name" Text="*" ValidationGroup="CONTROLS"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: left">
                        ...
                        <asp:ValidationSummary ID="vs_VALSummary" runat="server" ValidationGroup="CONTROLS"
