...
public partial class Reportss_LeaveApplicationReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                RPT_LeaveApplication.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
                Microsoft.Reporting.WebForms.ServerReport serverReport = default(Microsoft.Reporting.WebForms.ServerReport);
                serverReport = RPT_LeaveApplication.ServerReport;
                ...
                serverReport.ReportPath = MyReportPath + "LeaveApplicationReport";
                ...
                RPT_LeaveApplication.Visible = true;
            }
        }
        catch (Exception ex)
        {
            SMHR.BLL.Error_Log(Session["USER_ID"].ToString(), ex.TargetSite.ToString(), ex.Message.Replace("'", "''"), "LeaveApplicationReport", ex.StackTrace, DateTime.Now);
